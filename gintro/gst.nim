...
proc finalizerfree*(self: AllocationParams) =
  if not self.ignoreFinalizer:
    gst_allocation_params_free(self.impl)
...
proc gst_object_check_uniqueness(list: ptr pointer; name: cstring): gboolean {.
    importc, libprag.}

proc checkUniqueness*(list: ptr pointer; name: cstring): bool =
  toBool(gst_object_check_uniqueness(list, name))

proc gst_object_default_deep_notify(`object`: ptr gobject.Object00; orig: ptr Object00;
    pspec: ptr gobject.ParamSpec00; excludedProps: cstringArray) {.
    importc, libprag.}
...
proc defaultError*(self: Object; error: ptr glib.Error; debug: cstring = "") =
  gst_object_default_error(cast[ptr Object00](self.impl), error, safeStringToCString(debug))
...
proc gst_object_get_g_value_array(self: ptr Object00; propertyName: cstring;
    timestamp: uint64; interval: uint64; nValues: uint32; values: gobject.ValueArray): gboolean {.
    importc, libprag.}

proc getGValueArray*(self: Object; propertyName: cstring; timestamp: uint64;
    interval: uint64; nValues: int; values: gobject.ValueArray): bool =
  toBool(gst_object_get_g_value_array(cast[ptr Object00](self.impl), propertyName, timestamp, interval, uint32(nValues), values))

proc gValueArray*(self: Object; propertyName: cstring; timestamp: uint64;
    interval: uint64; nValues: int; values: gobject.ValueArray): bool =
  toBool(gst_object_get_g_value_array(cast[ptr Object00](self.impl), propertyName, timestamp, interval, uint32(nValues), values))
...
proc valueObject*(self: Object; propertyName: cstring; timestamp: uint64): ptr gobject.Value =
  gst_object_get_value(cast[ptr Object00](self.impl), propertyName, timestamp)
...
proc setName*(self: Object; name: cstring = ""): bool =
  toBool(gst_object_set_name(cast[ptr Object00](self.impl), safeStringToCString(name)))

proc `name=`*(self: Object; name: cstring = ""): bool =
  toBool(gst_object_set_name(cast[ptr Object00](self.impl), safeStringToCString(name)))
...
proc `parent=`*(self: Object; parent: Object): bool =
  toBool(gst_object_set_parent(cast[ptr Object00](self.impl), cast[ptr Object00](parent.impl)))
...
proc findAllocator*(name: cstring = ""): Allocator =
  let gobj = gst_allocator_find(safeStringToCString(name))
  if gobj.isNil:
    return nil
  let qdata = g_object_get_qdata(gobj, Quark)
  if qdata != nil:
...
proc registerAllocator*(name: cstring; allocator: Allocator) =
  gst_allocator_register(name, cast[ptr Allocator00](allocator.impl))

proc gst_allocator_set_default(self: ptr Allocator00) {.
    importc, libprag.}

proc setDefault*(self: Allocator) =
  gst_allocator_set_default(cast[ptr Allocator00](self.impl))

proc `default=`*(self: Allocator) =
  gst_allocator_set_default(cast[ptr Allocator00](self.impl))
...
proc gst_control_binding_get_g_value_array(self: ptr ControlBinding00; timestamp: uint64;
    interval: uint64; nValues: uint32; values: gobject.ValueArray): gboolean {.
    importc, libprag.}
...
proc gValueArray*(self: ControlBinding; timestamp: uint64;
    interval: uint64; nValues: int; values: gobject.ValueArray): bool =
  toBool(gst_control_binding_get_g_value_array(cast[ptr ControlBinding00](self.impl), timestamp, interval, uint32(nValues), values))
...
proc valueControlBinding*(self: ControlBinding; timestamp: uint64): ptr gobject.Value =
  gst_control_binding_get_value(cast[ptr ControlBinding00](self.impl), timestamp)
...
proc controlBinding*(self: Object; propertyName: cstring): ControlBinding =
  let gobj = gst_object_get_control_binding(cast[ptr Object00](self.impl), propertyName)
  if gobj.isNil:
    return nil
  let qdata = g_object_get_qdata(gobj, Quark)
...
proc getSizes*(self: Memory; offset: var uint64; maxsize: var uint64): uint64 =
  gst_memory_get_sizes(cast[ptr Memory00](self.impl), offset, maxsize)

proc sizes*(self: Memory; offset: var uint64; maxsize: var uint64): uint64 =
  gst_memory_get_sizes(cast[ptr Memory00](self.impl), offset, maxsize)
...
proc free*(self: Allocator; memory: Memory) =
  gst_allocator_free(cast[ptr Allocator00](self.impl), cast[ptr Memory00](memory.impl))
...
proc gst_memory_new_wrapped(flags: MemoryFlags; data: uint8Array; maxsize: uint64;
...
proc newMemoryWrapped*(flags: MemoryFlags; data: seq[uint8] | string;
  ...
  let impl0 = gst_memory_new_wrapped(flags, unsafeaddr(data[0]), maxsize, offset, size, userData, notify)
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstMemory)
  result.impl = impl0
...
type
  MapInfo00* {.pure.} = object
  MapInfo* = ref object
    impl*: ptr MapInfo00
    ignoreFinalizer*: bool

proc gst_memory_unmap(self: ptr Memory00; info: ptr MapInfo00) {.
    importc, libprag.}

proc unmap*(self: Memory; info: MapInfo) =
  gst_memory_unmap(cast[ptr Memory00](self.impl), cast[ptr MapInfo00](info.impl))
...
proc gst_memory_make_mapped(self: ptr Memory00; info: var MapInfo00; flags: MapFlags): ptr Memory00 {.
    importc, libprag.}

proc makeMapped*(self: Memory; info: var MapInfo00; flags: MapFlags): Memory =
  let impl0 = gst_memory_make_mapped(cast[ptr Memory00](self.impl), info, flags)
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstMemory)
  result.impl = impl0

proc gst_memory_map(self: ptr Memory00; info: var MapInfo00; flags: MapFlags): gboolean {.
    importc, libprag.}

proc map*(self: Memory; info: var MapInfo00; flags: MapFlags): bool =
...
proc finalizerunref*(self: AtomicQueue) =
  if not self.ignoreFinalizer:
    gst_atomic_queue_unref(self.impl)
...
proc `active=`*(self: Pad; active: bool): bool =
  toBool(gst_pad_set_active(cast[ptr Pad00](self.impl), gboolean(active)))
...
proc addPropertyDeepNotifyWatch*(self: Element; propertyName: cstring = "";
    includeValue: bool): uint64 =
  gst_element_add_property_deep_notify_watch(cast[ptr Element00](self.impl), safeStringToCString(propertyName), gboolean(includeValue))

proc gst_element_add_property_notify_watch(self: ptr Element00; propertyName: cstring;
    includeValue: gboolean): uint64 {.
    importc, libprag.}

proc addPropertyNotifyWatch*(self: Element; propertyName: cstring = "";
    includeValue: bool): uint64 =
  gst_element_add_property_notify_watch(cast[ptr Element00](self.impl), safeStringToCString(propertyName), gboolean(includeValue))
...
proc gst_element_get_contexts(self: ptr Element00): ptr pointer {.
    importc, libprag.}

proc getContexts*(self: Element): ptr pointer =
  gst_element_get_contexts(cast[ptr Element00](self.impl))

proc contexts*(self: Element): ptr pointer =
  gst_element_get_contexts(cast[ptr Element00](self.impl))
...
proc metadata*(self: Element; key: cstring): string =
  result = $gst_element_get_metadata(cast[ptr Element00](self.impl), key)

proc gst_element_get_pad_template_list(self: ptr Element00): ptr pointer {.
    importc, libprag.}

proc getPadTemplateList*(self: Element): ptr pointer =
  gst_element_get_pad_template_list(cast[ptr Element00](self.impl))

proc padTemplateList*(self: Element): ptr pointer =
  gst_element_get_pad_template_list(cast[ptr Element00](self.impl))
...
proc requestPad*(self: Element; name: cstring): Pad =
  let gobj = gst_element_get_request_pad(cast[ptr Element00](self.impl), name)
  if gobj.isNil:
    return nil
  let qdata = g_object_get_qdata(gobj, Quark)
...
proc staticPad*(self: Element; name: cstring): Pad =
  let gobj = gst_element_get_static_pad(cast[ptr Element00](self.impl), name)
  if gobj.isNil:
    return nil
  let qdata = g_object_get_qdata(gobj, Quark)
...
proc linkPads*(self: Element; srcpadname: cstring = ""; dest: Element;
    destpadname: cstring = ""): bool =
  toBool(gst_element_link_pads(cast[ptr Element00](self.impl), safeStringToCString(srcpadname), cast[ptr Element00](dest.impl), safeStringToCString(destpadname)))
...
proc `lockedState=`*(self: Element; lockedState: bool): bool =
  toBool(gst_element_set_locked_state(cast[ptr Element00](self.impl), gboolean(lockedState)))
...
proc newBin*(name: cstring = ""): Bin =
  let gobj = gst_bin_new(safeStringToCString(name))
  let qdata = g_object_get_qdata(gobj, Quark)
  if qdata != nil:
    result = cast[type(result)](qdata)
    assert(result.impl == gobj)
...
proc newBin*(tdesc: typedesc; name: cstring = ""): tdesc =
...
proc initBin*[T](result: var T; name: cstring = "") {.deprecated.} =
  assert(result is Bin)
  let gobj = gst_bin_new(safeStringToCString(name))
  let qdata = g_object_get_qdata(gobj, Quark)
  if qdata != nil:
...
proc byInterface*(self: Bin; iface: GType): Element =
  let gobj = gst_bin_get_by_interface(cast[ptr Bin00](self.impl), iface)
  if gobj.isNil:
    return nil
  let qdata = g_object_get_qdata(gobj, Quark)
...
proc byName*(self: Bin; name: cstring): Element =
  let gobj = gst_bin_get_by_name(cast[ptr Bin00](self.impl), name)
  if gobj.isNil:
    return nil
  let qdata = g_object_get_qdata(gobj, Quark)
...
proc byNameRecurseUp*(self: Bin; name: cstring): Element =
  let gobj = gst_bin_get_by_name_recurse_up(cast[ptr Bin00](self.impl), name)
  if gobj.isNil:
    return nil
  let qdata = g_object_get_qdata(gobj, Quark)
...
proc createStreamId*(self: Pad; parent: Element; streamId: cstring = ""): string =
  let resul0 = gst_pad_create_stream_id(cast[ptr Pad00](self.impl), cast[ptr Element00](parent.impl), safeStringToCString(streamId))
  result = $resul0
  cogfree(resul0)
...
proc getName*(stype: StreamType): string =
  let resul0 = gst_stream_type_get_name(stype)
  if resul0.isNil:
    return
  result = $resul0
...
proc booleanIndex*(self: TagList; tag: cstring; index: int;
    value: var bool): bool =
  var value_00 = gboolean(value)
  result = toBool(gst_tag_list_get_boolean_index(cast[ptr TagList00](self.impl), tag, uint32(index), value_00))
  value = toBool(value_00)
...
proc date*(self: TagList; tag: cstring; value: var glib.Date): bool =
  fnew(value, gBoxedFreeGDate)
  toBool(gst_tag_list_get_date(cast[ptr TagList00](self.impl), tag, cast[var ptr glib.Date00](addr value.impl)))
...
proc dateIndex*(self: TagList; tag: cstring; index: int;
    value: var glib.Date): bool =
  fnew(value, gBoxedFreeGDate)
  toBool(gst_tag_list_get_date_index(cast[ptr TagList00](self.impl), tag, uint32(index), cast[var ptr glib.Date00](addr value.impl)))
...
proc double*(self: TagList; tag: cstring; value: var cdouble): bool =
  toBool(gst_tag_list_get_double(cast[ptr TagList00](self.impl), tag, value))
...
proc doubleIndex*(self: TagList; tag: cstring; index: int;
    value: var cdouble): bool =
  toBool(gst_tag_list_get_double_index(cast[ptr TagList00](self.impl), tag, uint32(index), value))
...
proc floatIndex*(self: TagList; tag: cstring; index: int;
    value: var cfloat): bool =
  toBool(gst_tag_list_get_float_index(cast[ptr TagList00](self.impl), tag, uint32(index), value))
...
proc int64Index*(self: TagList; tag: cstring; index: int;
    value: var int64): bool =
  toBool(gst_tag_list_get_int64_index(cast[ptr TagList00](self.impl), tag, uint32(index), value))
...
proc intIndex*(self: TagList; tag: cstring; index: int;
    value: var int): bool =
  var value_00 = int32(value)
  result = toBool(gst_tag_list_get_int_index(cast[ptr TagList00](self.impl), tag, uint32(index), value_00))
  value = int(value_00)
...
proc pointerIndex*(self: TagList; tag: cstring; index: int;
    value: var pointer): bool =
  toBool(gst_tag_list_get_pointer_index(cast[ptr TagList00](self.impl), tag, uint32(index), value))
...
proc stringIndex*(self: TagList; tag: cstring; index: int;
    value: var string): bool =
  var value_00 = cstring(value)
  result = toBool(gst_tag_list_get_string_index(cast[ptr TagList00](self.impl), tag, uint32(index), value_00))
  value = $(value_00)
...
proc tagSize*(self: TagList; tag: cstring): int =
  int(gst_tag_list_get_tag_size(cast[ptr TagList00](self.impl), tag))
...
proc uint64Index*(self: TagList; tag: cstring; index: int;
    value: var uint64): bool =
  toBool(gst_tag_list_get_uint64_index(cast[ptr TagList00](self.impl), tag, uint32(index), value))
...
proc uintIndex*(self: TagList; tag: cstring; index: int;
    value: var int): bool =
  var value_00 = uint32(value)
  result = toBool(gst_tag_list_get_uint_index(cast[ptr TagList00](self.impl), tag, uint32(index), value_00))
  value = int(value_00)
...
proc valueIndex*(self: TagList; tag: cstring; index: int): ptr gobject.Value =
  gst_tag_list_get_value_index(cast[ptr TagList00](self.impl), tag, uint32(index))
...
proc newDateTimeFromGDateTime*(dt: glib.DateTime): DateTime =
  let impl0 = gst_date_time_new_from_g_date_time(cast[ptr glib.DateTime00](dt.impl))
  if impl0.isNil:
    return nil
...
proc newDateTimeFromUnixEpochLocalTime*(secs: int64): DateTime =
  fnew(result, gBoxedFreeGstDateTime)
  result.impl = gst_date_time_new_from_unix_epoch_local_time(secs)
...
proc newDateTimeFromUnixEpochUtc*(secs: int64): DateTime =
  fnew(result, gBoxedFreeGstDateTime)
  result.impl = gst_date_time_new_from_unix_epoch_utc(secs)
...
proc newDateTimeLocalTime*(year: int; month: int; day: int; hour: int;
  ...
  fnew(result, gBoxedFreeGstDateTime)
  result.impl = gst_date_time_new_local_time(int32(year), int32(month), int32(day), int32(hour), int32(minute), seconds)
...
proc newDateTimeY*(year: int): DateTime =
  fnew(result, gBoxedFreeGstDateTime)
  result.impl = gst_date_time_new_y(int32(year))
...
proc newDateTimeYm*(year: int; month: int): DateTime =
  fnew(result, gBoxedFreeGstDateTime)
  result.impl = gst_date_time_new_ym(int32(year), int32(month))
...
proc newDateTimeYmd*(year: int; month: int; day: int): DateTime =
  fnew(result, gBoxedFreeGstDateTime)
  result.impl = gst_date_time_new_ymd(int32(year), int32(month), int32(day))
...
proc newDateTime*(tzoffset: cfloat; year: int; month: int; day: int;
  ...
  fnew(result, gBoxedFreeGstDateTime)
  result.impl = gst_date_time_new(tzoffset, int32(year), int32(month), int32(day), int32(hour), int32(minute), seconds)
...
proc dateTime*(self: TagList; tag: cstring; value: var DateTime): bool =
  fnew(value, gBoxedFreeGstDateTime)
  toBool(gst_tag_list_get_date_time(cast[ptr TagList00](self.impl), tag, cast[var ptr DateTime00](addr value.impl)))
...
proc dateTimeIndex*(self: TagList; tag: cstring; index: int;
    value: var DateTime): bool =
  fnew(value, gBoxedFreeGstDateTime)
  toBool(gst_tag_list_get_date_time_index(cast[ptr TagList00](self.impl), tag, uint32(index), cast[var ptr DateTime00](addr value.impl)))
...
proc sample*(self: TagList; tag: cstring; sample: var Sample): bool =
  fnew(sample, gBoxedFreeGstSample)
  toBool(gst_tag_list_get_sample(cast[ptr TagList00](self.impl), tag, cast[var ptr Sample00](addr sample.impl)))
...
proc sampleIndex*(self: TagList; tag: cstring; index: int;
    sample: var Sample): bool =
  fnew(sample, gBoxedFreeGstSample)
  toBool(gst_tag_list_get_sample_index(cast[ptr TagList00](self.impl), tag, uint32(index), cast[var ptr Sample00](addr sample.impl)))
...
proc array*(self: Structure; fieldname: cstring; array: var gobject.ValueArray): bool =
  fnew(array, gBoxedFreeGValueArray)
  toBool(gst_structure_get_array(cast[ptr Structure00](self.impl), fieldname, cast[var ptr gobject.ValueArray00](addr array.impl)))
...
proc boolean*(self: Structure; fieldname: cstring; value: var bool): bool =
  var value_00 = gboolean(value)
  result = toBool(gst_structure_get_boolean(cast[ptr Structure00](self.impl), fieldname, value_00))
  value = toBool(value_00)
...
proc clockTime*(self: Structure; fieldname: cstring; value: var uint64): bool =
  toBool(gst_structure_get_clock_time(cast[ptr Structure00](self.impl), fieldname, value))
...
proc date*(self: Structure; fieldname: cstring; value: var glib.Date): bool =
  fnew(value, gBoxedFreeGDate)
  toBool(gst_structure_get_date(cast[ptr Structure00](self.impl), fieldname, cast[var ptr glib.Date00](addr value.impl)))
...
proc dateTime*(self: Structure; fieldname: cstring; value: var DateTime): bool =
  fnew(value, gBoxedFreeGstDateTime)
  toBool(gst_structure_get_date_time(cast[ptr Structure00](self.impl), fieldname, cast[var ptr DateTime00](addr value.impl)))
...
proc double*(self: Structure; fieldname: cstring; value: var cdouble): bool =
  toBool(gst_structure_get_double(cast[ptr Structure00](self.impl), fieldname, value))
...
proc fieldType*(self: Structure; fieldname: cstring): GType =
  gst_structure_get_field_type(cast[ptr Structure00](self.impl), fieldname)
...
proc getFlagset*(self: Structure; fieldname: cstring; valueFlags: var int;
    valueMask: var int): bool =
  var valueMask_00 = uint32(valueMask)
  var valueFlags_00 = uint32(valueFlags)
...
proc flagset*(self: Structure; fieldname: cstring; valueFlags: var int;
    valueMask: var int): bool =
  var valueMask_00 = uint32(valueMask)
  var valueFlags_00 = uint32(valueFlags)
  result = toBool(gst_structure_get_flagset(cast[ptr Structure00](self.impl), fieldname, valueFlags_00, valueMask_00))
...
proc getFraction*(self: Structure; fieldname: cstring; valueNumerator: var int;
  ...
  var valueNumerator_00 = int32(valueNumerator)
  var valueDenominator_00 = int32(valueDenominator)
...
proc fraction*(self: Structure; fieldname: cstring; valueNumerator: var int;
    valueDenominator: var int): bool =
  var valueNumerator_00 = int32(valueNumerator)
  var valueDenominator_00 = int32(valueDenominator)
  result = toBool(gst_structure_get_fraction(cast[ptr Structure00](self.impl), fieldname, valueNumerator_00, valueDenominator_00))
...
proc listStructure*(self: Structure; fieldname: cstring; array: var gobject.ValueArray): bool =
  fnew(array, gBoxedFreeGValueArray)
  toBool(gst_structure_get_list(cast[ptr Structure00](self.impl), fieldname, cast[var ptr gobject.ValueArray00](addr array.impl)))
...
proc valueStructure*(self: Structure; fieldname: cstring): ptr gobject.Value =
  gst_structure_get_value(cast[ptr Structure00](self.impl), fieldname)
...
proc `parentRefcount=`*(self: Structure; refcount: ptr int32): bool =
  toBool(gst_structure_set_parent_refcount(cast[ptr Structure00](self.impl), refcount))
...
proc setInfo*(self: Sample; info: Structure): bool =
  toBool(gst_sample_set_info(cast[ptr Sample00](self.impl), cast[ptr Structure00](info.impl)))

proc `info=`*(self: Sample; info: Structure): bool =
  toBool(gst_sample_set_info(cast[ptr Sample00](self.impl), cast[ptr Structure00](info.impl)))
...
proc gst_buffer_new_wrapped(data: uint8Array; size: uint64): ptr Buffer00 {.
    importc, libprag.}

proc newBufferWrapped*(data: seq[uint8] | string): Buffer =
  let size = uint64(data.len)
  fnew(result, gBoxedFreeGstBuffer)
  result.impl = gst_buffer_new_wrapped(unsafeaddr(data[0]), size)
...
proc gst_buffer_new_wrapped_full(flags: MemoryFlags; data: uint8Array; maxsize: uint64;
...
proc newBufferWrappedFull*(flags: MemoryFlags; data: seq[uint8] | string;
  ...
  let size = uint64(data.len)
  fnew(result, gBoxedFreeGstBuffer)
  result.impl = gst_buffer_new_wrapped_full(flags, unsafeaddr(data[0]), maxsize, offset, size, userData, notify)
...
proc append*(self: Buffer; buf2: Buffer): Buffer =
  fnew(result, gBoxedFreeGstBuffer)
  result.impl = gst_buffer_append(cast[ptr Buffer00](self.impl), cast[ptr Buffer00](buf2.impl))

proc gst_buffer_append_memory(self: ptr Buffer00; mem: ptr Memory00) {.
    importc, libprag.}

proc appendMemory*(self: Buffer; mem: Memory) =
  gst_buffer_append_memory(cast[ptr Buffer00](self.impl), cast[ptr Memory00](mem.impl))
...
proc appendRegion*(self: Buffer; buf2: Buffer; offset: int64;
    size: int64): Buffer =
  fnew(result, gBoxedFreeGstBuffer)
  result.impl = gst_buffer_append_region(cast[ptr Buffer00](self.impl), cast[ptr Buffer00](buf2.impl), offset, size)
...
proc gst_buffer_extract(self: ptr Buffer00; offset: uint64; dest: uint8Array;
    size: var uint64): uint64 {.
    importc, libprag.}

proc extract*(self: Buffer; offset: uint64; dest: var (seq[uint8] | string);
    size: var uint64): uint64 =
  gst_buffer_extract(cast[ptr Buffer00](self.impl), offset, unsafeaddr(dest[0]), size)

proc gst_buffer_extract_dup(self: ptr Buffer00; offset: uint64; size: uint64;
    dest: var uint8Array; destSize: var uint64) {.
    importc, libprag.}
...
proc gst_buffer_fill(self: ptr Buffer00; offset: uint64; src: uint8Array;
    size: uint64): uint64 {.
    importc, libprag.}

proc fill*(self: Buffer; offset: uint64; src: seq[uint8] | string): uint64 =
  let size = uint64(src.len)
  gst_buffer_fill(cast[ptr Buffer00](self.impl), offset, unsafeaddr(src[0]), size)
...
proc memory*(self: Buffer; idx: int): Memory =
  let impl0 = gst_buffer_get_memory(cast[ptr Buffer00](self.impl), uint32(idx))
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstMemory)
...
proc memoryRange*(self: Buffer; idx: int; length: int): Memory =
  let impl0 = gst_buffer_get_memory_range(cast[ptr Buffer00](self.impl), uint32(idx), int32(length))
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstMemory)
...
proc nMeta*(self: Buffer; apiType: GType): int =
  int(gst_buffer_get_n_meta(cast[ptr Buffer00](self.impl), apiType))
...
proc getSizes*(self: Buffer; offset: var uint64; maxsize: var uint64): uint64 =
  gst_buffer_get_sizes(cast[ptr Buffer00](self.impl), offset, maxsize)

proc sizes*(self: Buffer; offset: var uint64; maxsize: var uint64): uint64 =
  gst_buffer_get_sizes(cast[ptr Buffer00](self.impl), offset, maxsize)
...
proc getSizesRange*(self: Buffer; idx: int; length: int; offset: var uint64;
    maxsize: var uint64): uint64 =
  gst_buffer_get_sizes_range(cast[ptr Buffer00](self.impl), uint32(idx), int32(length), offset, maxsize)

proc sizesRange*(self: Buffer; idx: int; length: int; offset: var uint64;
    maxsize: var uint64): uint64 =
  gst_buffer_get_sizes_range(cast[ptr Buffer00](self.impl), uint32(idx), int32(length), offset, maxsize)
...
proc insertMemory*(self: Buffer; idx: int; mem: Memory) =
  gst_buffer_insert_memory(cast[ptr Buffer00](self.impl), int32(idx), cast[ptr Memory00](mem.impl))
...
proc gst_buffer_map(self: ptr Buffer00; info: var MapInfo00; flags: MapFlags): gboolean {.
    importc, libprag.}

proc map*(self: Buffer; info: var MapInfo00; flags: MapFlags): bool =
...
proc gst_buffer_map_range(self: ptr Buffer00; idx: uint32; length: int32;
    info: var MapInfo00; flags: MapFlags): gboolean {.
    importc, libprag.}

proc mapRange*(self: Buffer; idx: int; length: int; info: var MapInfo00;
    flags: MapFlags): bool =
  toBool(gst_buffer_map_range(cast[ptr Buffer00](self.impl), uint32(idx), int32(length), info, flags))

proc gst_buffer_memcmp(self: ptr Buffer00; offset: uint64; mem: uint8Array;
    size: uint64): int32 {.
    importc, libprag.}

proc memcmp*(self: Buffer; offset: uint64; mem: seq[uint8] | string): int =
  let size = uint64(mem.len)
  int(gst_buffer_memcmp(cast[ptr Buffer00](self.impl), offset, unsafeaddr(mem[0]), size))
...
proc prependMemory*(self: Buffer; mem: Memory) =
  gst_buffer_prepend_memory(cast[ptr Buffer00](self.impl), cast[ptr Memory00](mem.impl))
...
proc replaceAllMemory*(self: Buffer; mem: Memory) =
  gst_buffer_replace_all_memory(cast[ptr Buffer00](self.impl), cast[ptr Memory00](mem.impl))
...
proc replaceMemory*(self: Buffer; idx: int; mem: Memory) =
  gst_buffer_replace_memory(cast[ptr Buffer00](self.impl), uint32(idx), cast[ptr Memory00](mem.impl))
...
proc replaceMemoryRange*(self: Buffer; idx: int; length: int;
    mem: Memory) =
  gst_buffer_replace_memory_range(cast[ptr Buffer00](self.impl), uint32(idx), int32(length), cast[ptr Memory00](mem.impl))
...
proc gst_buffer_unmap(self: ptr Buffer00; info: ptr MapInfo00) {.
    importc, libprag.}

proc unmap*(self: Buffer; info: MapInfo) =
  gst_buffer_unmap(cast[ptr Buffer00](self.impl), cast[ptr MapInfo00](info.impl))
...
proc chain*(self: Pad; buffer: Buffer): FlowReturn =
  gst_pad_chain(cast[ptr Pad00](self.impl), cast[ptr Buffer00](buffer.impl))
...
proc range*(self: Pad; offset: uint64; size: int; buffer: var Buffer): FlowReturn =
  fnew(buffer, gBoxedFreeGstBuffer)
  gst_pad_get_range(cast[ptr Pad00](self.impl), offset, uint32(size), cast[var ptr Buffer00](addr buffer.impl))
...
proc push*(self: Pad; buffer: Buffer): FlowReturn =
  gst_pad_push(cast[ptr Pad00](self.impl), cast[ptr Buffer00](buffer.impl))
...
proc infoParentBufferMeta*(): MetaInfo =
  new(result)
  result.impl = gst_parent_buffer_meta_get_info()
  result.ignoreFinalizer = true
...
proc infoProtectionMeta*(): MetaInfo =
  new(result)
  result.impl = gst_protection_meta_get_info()
  result.ignoreFinalizer = true
...
proc addProtectionMeta*(self: Buffer; info: Structure): ProtectionMeta =
  new(result)
  result.impl = gst_buffer_add_protection_meta(cast[ptr Buffer00](self.impl), cast[ptr Structure00](info.impl))
  result.ignoreFinalizer = true
...
proc gst_meta_api_type_get_tags(api: GType): cstringArray {.
    importc, libprag.}
...
proc gst_meta_api_type_register(api: cstring; tags: cstringArray): GType {.
    importc, libprag.}
...
proc meta*(self: Buffer; api: GType): Meta =
  let impl0 = gst_buffer_get_meta(cast[ptr Buffer00](self.impl), api)
  if impl0.isNil:
    return nil
  new(result)
...
proc `flags=`*(self: Buffer; flags: BufferFlags): bool =
  toBool(gst_buffer_set_flags(cast[ptr Buffer00](self.impl), flags))
...
proc bufferList*(self: BufferList; idx: int): Buffer =
  let impl0 = gst_buffer_list_get(cast[ptr BufferList00](self.impl), uint32(idx))
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstBuffer)
...
proc writable*(self: BufferList; idx: int): Buffer =
  let impl0 = gst_buffer_list_get_writable(cast[ptr BufferList00](self.impl), uint32(idx))
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstBuffer)
...
proc insert*(self: BufferList; idx: int; buffer: Buffer) =
  gst_buffer_list_insert(cast[ptr BufferList00](self.impl), int32(idx), cast[ptr Buffer00](buffer.impl))
...
proc chainList*(self: Pad; list: BufferList): FlowReturn =
  gst_pad_chain_list(cast[ptr Pad00](self.impl), cast[ptr BufferList00](list.impl))

proc gst_pad_push_list(self: ptr Pad00; list: ptr BufferList00): FlowReturn {.
    importc, libprag.}

proc pushList*(self: Pad; list: BufferList): FlowReturn =
  gst_pad_push_list(cast[ptr Pad00](self.impl), cast[ptr BufferList00](list.impl))
...
proc makeFromUri*(`type`: URIType; uri: cstring; elementname: cstring = ""): Element =
  var gerror: ptr glib.Error
  let gobj = gst_element_make_from_uri(`type`, uri, safeStringToCString(elementname), addr gerror)
  if gerror != nil:
...
proc listFreePlugin*(list: ptr pointer) {.
...
proc getFilename*(self: Plugin): string =
  result = $gst_plugin_get_filename(cast[ptr Plugin00](self.impl))
...
proc setCacheData*(self: Plugin; cacheData: Structure) =
  gst_plugin_set_cache_data(cast[ptr Plugin00](self.impl), cast[ptr Structure00](cacheData.impl))
...
proc gst_plugin_add_dependency(self: ptr Plugin00; envVars: cstringArray;
    paths: cstringArray; names: cstringArray; flags: PluginDependencyFlags) {.
    importc, libprag.}
...
proc addDependencySimple*(self: Plugin; envVars: cstring = "";
    paths: cstring = ""; names: cstring = ""; flags: PluginDependencyFlags) =
  gst_plugin_add_dependency_simple(cast[ptr Plugin00](self.impl), safeStringToCString(envVars), safeStringToCString(paths), safeStringToCString(names), flags)
...
proc listCopy*(list: ptr pointer): ptr pointer {.
    importc: "gst_plugin_feature_list_copy", libprag.}

proc listDebug*(list: ptr pointer) {.
    importc: "gst_plugin_feature_list_debug", libprag.}

proc listFreePluginFeature*(list: ptr pointer) {.
...
proc create*(self: ElementFactory; name: cstring = ""): Element =
  let gobj = gst_element_factory_create(cast[ptr ElementFactory00](self.impl), safeStringToCString(name))
  if gobj.isNil:
    return nil
  let qdata = g_object_get_qdata(gobj, Quark)
  if qdata != nil:
...
proc metadata*(self: ElementFactory; key: cstring): string =
  let resul0 = gst_element_factory_get_metadata(cast[ptr ElementFactory00](self.impl), key)
  if resul0.isNil:
    return
  result = $resul0

proc gst_element_factory_get_metadata_keys(self: ptr ElementFactory00): cstringArray {.
    importc, libprag.}
...
proc gst_element_factory_get_static_pad_templates(self: ptr ElementFactory00): ptr pointer {.
    importc, libprag.}

proc getStaticPadTemplates*(self: ElementFactory): ptr pointer =
  gst_element_factory_get_static_pad_templates(cast[ptr ElementFactory00](self.impl))

proc staticPadTemplates*(self: ElementFactory): ptr pointer =
  gst_element_factory_get_static_pad_templates(cast[ptr ElementFactory00](self.impl))

proc gst_element_factory_get_uri_protocols(self: ptr ElementFactory00): cstringArray {.
    importc, libprag.}
...
proc listGetElements*(`type`: uint64; minrank: Rank): ptr pointer {.
    importc: "gst_element_factory_list_get_elements", libprag.}
...
proc append*(self: Caps; caps2: Caps) =
  gst_caps_append(cast[ptr Caps00](self.impl), cast[ptr Caps00](caps2.impl))
...
proc appendStructure*(self: Caps; structure: Structure) =
  gst_caps_append_structure(cast[ptr Caps00](self.impl), cast[ptr Structure00](structure.impl))
...
proc fixate*(self: Caps): Caps =
  fnew(result, gBoxedFreeGstCaps)
  result.impl = gst_caps_fixate(cast[ptr Caps00](self.impl))
...
proc structure*(self: Caps; index: int): Structure =
  fnew(result, gBoxedFreeGstStructure)
  result.impl = gst_caps_get_structure(cast[ptr Caps00](self.impl), uint32(index))
  result.ignoreFinalizer = true
...
proc merge*(self: Caps; caps2: Caps): Caps =
  fnew(result, gBoxedFreeGstCaps)
  result.impl = gst_caps_merge(cast[ptr Caps00](self.impl), cast[ptr Caps00](caps2.impl))
...
proc mergeStructure*(self: Caps; structure: Structure): Caps =
  fnew(result, gBoxedFreeGstCaps)
  result.impl = gst_caps_merge_structure(cast[ptr Caps00](self.impl), cast[ptr Structure00](structure.impl))
...
proc normalize*(self: Caps): Caps =
  fnew(result, gBoxedFreeGstCaps)
  result.impl = gst_caps_normalize(cast[ptr Caps00](self.impl))
...
proc simplify*(self: Caps): Caps =
  fnew(result, gBoxedFreeGstCaps)
  result.impl = gst_caps_simplify(cast[ptr Caps00](self.impl))
...
proc truncate*(self: Caps): Caps =
  fnew(result, gBoxedFreeGstCaps)
  result.impl = gst_caps_truncate(cast[ptr Caps00](self.impl))
...
proc compatiblePad*(self: Element; pad: Pad; caps: Caps = nil): Pad =
  let gobj = gst_element_get_compatible_pad(cast[ptr Element00](self.impl), cast[ptr Pad00](pad.impl), if caps.isNil: nil else: cast[ptr Caps00](caps.impl))
  if gobj.isNil:
    return nil
  let qdata = g_object_get_qdata(gobj, Quark)
...
proc linkPadsFiltered*(self: Element; srcpadname: cstring = "";
    dest: Element; destpadname: cstring = ""; filter: Caps = nil): bool =
  toBool(gst_element_link_pads_filtered(cast[ptr Element00](self.impl), safeStringToCString(srcpadname), cast[ptr Element00](dest.impl), safeStringToCString(destpadname), if filter.isNil: nil else: cast[ptr Caps00](filter.impl)))
...
proc newStream*(streamId: cstring = ""; caps: Caps = nil; `type`: StreamType;
    flags: StreamFlags): Stream =
  let gobj = gst_stream_new(safeStringToCString(streamId), if caps.isNil: nil else: cast[ptr Caps00](caps.impl), `type`, flags)
  let qdata = g_object_get_qdata(gobj, Quark)
  if qdata != nil:
    result = cast[type(result)](qdata)
    assert(result.impl == gobj)
...
proc newStream*(tdesc: typedesc; streamId: cstring = ""; caps: Caps = nil; `type`: StreamType;
...
proc initStream*[T](result: var T; streamId: cstring = ""; caps: Caps = nil; `type`: StreamType;
...
proc newSample*(buffer: Buffer = nil; caps: Caps = nil; segment: Segment = nil;
  ...
  result.impl = gst_sample_new(if buffer.isNil: nil else: cast[ptr Buffer00](buffer.impl), if caps.isNil: nil else: cast[ptr Caps00](caps.impl), if segment.isNil: nil else: cast[ptr Segment00](segment.impl), if info.isNil: nil else: cast[ptr Structure00](info.impl))
...
proc infoReferenceTimestampMeta*(): MetaInfo =
  new(result)
  result.impl = gst_reference_timestamp_meta_get_info()
  result.ignoreFinalizer = true
...
proc referenceTimestampMeta*(self: Buffer; reference: Caps = nil): ReferenceTimestampMeta =
  let impl0 = gst_buffer_get_reference_timestamp_meta(cast[ptr Buffer00](self.impl), if reference.isNil: nil else: cast[ptr Caps00](reference.impl))
  if impl0.isNil:
    return nil
  new(result)
...
proc finalizerfree*(self: CapsFeatures) =
  if not self.ignoreFinalizer:
    gst_caps_features_free(self.impl)
...
proc nth*(self: CapsFeatures; i: int): string =
  let resul0 = gst_caps_features_get_nth(cast[ptr CapsFeatures00](self.impl), uint32(i))
  if resul0.isNil:
    return
  result = $resul0
...
proc nthId*(self: CapsFeatures; i: int): int =
  int(gst_caps_features_get_nth_id(cast[ptr CapsFeatures00](self.impl), uint32(i)))
...
proc `parentRefcount=`*(self: CapsFeatures; refcount: ptr int32): bool =
  toBool(gst_caps_features_set_parent_refcount(cast[ptr CapsFeatures00](self.impl), refcount))
...
proc appendStructureFull*(self: Caps; structure: Structure; features: CapsFeatures = nil) =
  gst_caps_append_structure_full(cast[ptr Caps00](self.impl), cast[ptr Structure00](structure.impl), if features.isNil: nil else: cast[ptr CapsFeatures00](features.impl))
...
proc features*(self: Caps; index: int): CapsFeatures =
  let impl0 = gst_caps_get_features(cast[ptr Caps00](self.impl), uint32(index))
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstCapsFeatures)
...
proc mergeStructureFull*(self: Caps; structure: Structure; features: CapsFeatures = nil): Caps =
  fnew(result, gBoxedFreeGstCaps)
  result.impl = gst_caps_merge_structure_full(cast[ptr Caps00](self.impl), cast[ptr Structure00](structure.impl), if features.isNil: nil else: cast[ptr CapsFeatures00](features.impl))
...
proc setFeatures*(self: Caps; index: int; features: CapsFeatures = nil) =
  gst_caps_set_features(cast[ptr Caps00](self.impl), uint32(index), if features.isNil: nil else: cast[ptr CapsFeatures00](features.impl))
...
proc setFeaturesSimple*(self: Caps; features: CapsFeatures = nil) =
  gst_caps_set_features_simple(cast[ptr Caps00](self.impl), if features.isNil: nil else: cast[ptr CapsFeatures00](features.impl))
...
proc linkPadsFull*(self: Element; srcpadname: cstring = "";
    dest: Element; destpadname: cstring = ""; flags: PadLinkCheck): bool =
  toBool(gst_element_link_pads_full(cast[ptr Element00](self.impl), safeStringToCString(srcpadname), cast[ptr Element00](dest.impl), safeStringToCString(destpadname), flags))
...
proc messageFull*(self: Element; `type`: MessageType; domain: int;
    code: int; text: cstring = ""; debug: cstring = ""; file: cstring; function: cstring;
    line: int) =
  gst_element_message_full(cast[ptr Element00](self.impl), `type`, uint32(domain), int32(code), safeStringToCString(text), safeStringToCString(debug), file, function, int32(line))
...
proc messageFullWithDetails*(self: Element; `type`: MessageType;
    domain: int; code: int; text: cstring = ""; debug: cstring = ""; file: cstring;
    function: cstring; line: int; structure: Structure) =
  gst_element_message_full_with_details(cast[ptr Element00](self.impl), `type`, uint32(domain), int32(code), safeStringToCString(text), safeStringToCString(debug), file, function, int32(line), cast[ptr Structure00](structure.impl))
...
proc findAllocationMeta*(self: Query; api: GType; index: var int): bool =
  var index_00 = uint32(index)
...
proc parseAllocation*(self: Query; caps: var Caps; needPool: var bool) =
  fnew(caps, gBoxedFreeGstCaps)
  caps.ignoreFinalizer = true
  var needPool_00 = gboolean(needPool)
  gst_query_parse_allocation(cast[ptr Query00](self.impl), cast[var ptr Caps00](addr caps.impl), needPool_00)
  needPool = toBool(needPool_00)

proc gst_query_parse_bitrate(self: ptr Query00; nominalBitrate: var uint32) {.
    importc, libprag.}

proc parseBitrate*(self: Query; nominalBitrate: var int) =
  var nominalBitrate_00 = uint32(nominalBitrate)
...
proc parseBufferingPercent*(self: Query; busy: var bool; percent: var int) =
  var percent_00 = int32(percent)
  var busy_00 = gboolean(busy)
...
proc parseContextType*(self: Query; contextType: var string): bool =
  var contextType_00 = cstring(contextType)
...
proc parseLatency*(self: Query; live: var bool; minLatency: var uint64;
    maxLatency: var uint64) =
  var live_00 = gboolean(live)
...
proc parseNFormats*(self: Query; nFormats: var int) =
  var nFormats_00 = uint32(nFormats)
...
proc parseNthAllocationMeta*(self: Query; index: int; params: var Structure): GType =
  fnew(params, gBoxedFreeGstStructure)
  params.ignoreFinalizer = true
  gst_query_parse_nth_allocation_meta(cast[ptr Query00](self.impl), uint32(index), cast[var ptr Structure00](addr params.impl))
...
proc parseNthAllocationParam*(self: Query; index: int; allocator: var Allocator;
    params: var AllocationParams00) =
  fnew(allocator, gst.finalizeGObject)
  gst_query_parse_nth_allocation_param(cast[ptr Query00](self.impl), uint32(index), cast[var ptr Allocator00](addr allocator.impl), params)

proc gst_query_parse_nth_buffering_range(self: ptr Query00; index: uint32;
    start: var int64; stop: var int64): gboolean {.
    importc, libprag.}

proc parseNthBufferingRange*(self: Query; index: int; start: var int64;
    stop: var int64): bool =
...
proc parseUri*(self: Query; uri: var string) =
  var uri_00 = cstring(uri)
...
proc parseUriRedirection*(self: Query; uri: var string) =
  var uri_00 = cstring(uri)
...
proc parseUriRedirectionPermanent*(self: Query; permanent: var bool) =
  var permanent_00 = gboolean(permanent)
...
proc newQueryCustom*(`type`: QueryType; structure: Structure = nil): Query =
  let impl0 = gst_query_new_custom(`type`, if structure.isNil: nil else: cast[ptr Structure00](structure.impl))
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstQuery)
  result.impl = impl0
...
proc parseBufferingStats*(self: Query; mode: var BufferingMode;
    avgIn: var int; avgOut: var int; bufferingLeft: var int64) =
  var avgOut_00 = int32(avgOut)
  var avgIn_00 = int32(avgIn)
...
proc configGetAllocator*(config: Structure; allocator: var Allocator;
    params: var AllocationParams00): bool =
  fnew(allocator, gst.finalizeGObject)
  allocator.ignoreFinalizer = true
  toBool(gst_buffer_pool_config_get_allocator(cast[ptr Structure00](config.impl), cast[var ptr Allocator00](addr allocator.impl), params))
...
proc configGetOption*(config: Structure; index: int): string =
  result = $gst_buffer_pool_config_get_option(cast[ptr Structure00](config.impl), uint32(index))
...
proc configGetParams*(config: Structure; caps: var Caps;
    size: var int; minBuffers: var int; maxBuffers: var int): bool =
  fnew(caps, gBoxedFreeGstCaps)
  caps.ignoreFinalizer = true
  var minBuffers_00 = uint32(minBuffers)
  var maxBuffers_00 = uint32(maxBuffers)
  var size_00 = uint32(size)
  result = toBool(gst_buffer_pool_config_get_params(cast[ptr Structure00](config.impl), cast[var ptr Caps00](addr caps.impl), size_00, minBuffers_00, maxBuffers_00))
...
proc configSetParams*(config: Structure; caps: Caps; size: int;
    minBuffers: int; maxBuffers: int) =
  gst_buffer_pool_config_set_params(cast[ptr Structure00](config.impl), cast[ptr Caps00](caps.impl), uint32(size), uint32(minBuffers), uint32(maxBuffers))
...
proc configValidateParams*(config: Structure; caps: Caps;
    size: int; minBuffers: int; maxBuffers: int): bool =
  toBool(gst_buffer_pool_config_validate_params(cast[ptr Structure00](config.impl), cast[ptr Caps00](caps.impl), uint32(size), uint32(minBuffers), uint32(maxBuffers)))
...
proc gst_buffer_pool_get_options(self: ptr BufferPool00): cstringArray {.
    importc, libprag.}
...
proc releaseBuffer*(self: BufferPool; buffer: Buffer) =
  gst_buffer_pool_release_buffer(cast[ptr BufferPool00](self.impl), cast[ptr Buffer00](buffer.impl))
...
proc `active=`*(self: BufferPool; active: bool): bool =
  toBool(gst_buffer_pool_set_active(cast[ptr BufferPool00](self.impl), gboolean(active)))
...
proc setConfig*(self: BufferPool; config: Structure): bool =
  toBool(gst_buffer_pool_set_config(cast[ptr BufferPool00](self.impl), cast[ptr Structure00](config.impl)))

proc `config=`*(self: BufferPool; config: Structure): bool =
  toBool(gst_buffer_pool_set_config(cast[ptr BufferPool00](self.impl), cast[ptr Structure00](config.impl)))
...
proc parseNthAllocationPool*(self: Query; index: int; pool: var BufferPool;
    size: var int; minBuffers: var int; maxBuffers: var int) =
  fnew(pool, gst.finalizeGObject)
  var minBuffers_00 = uint32(minBuffers)
  var maxBuffers_00 = uint32(maxBuffers)
  var size_00 = uint32(size)
  gst_query_parse_nth_allocation_pool(cast[ptr Query00](self.impl), uint32(index), cast[var ptr BufferPool00](addr pool.impl), size_00, minBuffers_00, maxBuffers_00)
  minBuffers = int(minBuffers_00)
  maxBuffers = int(maxBuffers_00)
  size = int(size_00)
...
proc parseScheduling*(self: Query; flags: var SchedulingFlags;
    minsize: var int; maxsize: var int; align: var int) =
  var align_00 = int32(align)
  var maxsize_00 = int32(maxsize)
  var minsize_00 = int32(minsize)
...
proc newPadFromTemplate*(templ: PadTemplate; name: cstring = ""): Pad =
  let gobj = gst_pad_new_from_template(cast[ptr PadTemplate00](templ.impl), safeStringToCString(name))
  let qdata = g_object_get_qdata(gobj, Quark)
  if qdata != nil:
    result = cast[type(result)](qdata)
    assert(result.impl == gobj)
...
proc newPadFromTemplate*(tdesc: typedesc; templ: PadTemplate; name: cstring = ""): tdesc =
  assert(result is Pad)
  let gobj = gst_pad_new_from_template(cast[ptr PadTemplate00](templ.impl), safeStringToCString(name))
  let qdata = g_object_get_qdata(gobj, Quark)
  if qdata != nil:
...
proc initPadFromTemplate*[T](result: var T; templ: PadTemplate; name: cstring = "") {.deprecated.} =
  assert(result is Pad)
  let gobj = gst_pad_new_from_template(cast[ptr PadTemplate00](templ.impl), safeStringToCString(name))
  let qdata = g_object_get_qdata(gobj, Quark)
  if qdata != nil:
...
proc compatiblePadTemplate*(self: Element; compattempl: PadTemplate): PadTemplate =
  let gobj = gst_element_get_compatible_pad_template(cast[ptr Element00](self.impl), cast[ptr PadTemplate00](compattempl.impl))
  if gobj.isNil:
    return nil
  let qdata = g_object_get_qdata(gobj, Quark)
...
proc padTemplate*(self: Element; name: cstring): PadTemplate =
  let gobj = gst_element_get_pad_template(cast[ptr Element00](self.impl), name)
  if gobj.isNil:
    return nil
  let qdata = g_object_get_qdata(gobj, Quark)
...
proc requestPad*(self: Element; templ: PadTemplate; name: cstring = "";
    caps: Caps = nil): Pad =
  let gobj = gst_element_request_pad(cast[ptr Element00](self.impl), cast[ptr PadTemplate00](templ.impl), safeStringToCString(name), if caps.isNil: nil else: cast[ptr Caps00](caps.impl))
  if gobj.isNil:
    return nil
  let qdata = g_object_get_qdata(gobj, Quark)
  if qdata != nil:
...
proc peerQueryDuration*(self: Pad; format: Format; duration: var int64): bool =
...
proc peerQueryPosition*(self: Pad; format: Format; cur: var int64): bool =
...
proc queryDuration*(self: Pad; format: Format; duration: var int64): bool =
...
proc queryPosition*(self: Pad; format: Format; cur: var int64): bool =
...
proc queryDuration*(self: Element; format: Format; duration: var int64): bool =
...
proc queryPosition*(self: Element; format: Format; cur: var int64): bool =
...
proc clip*(self: Segment; format: Format; start: uint64; stop: uint64;
    clipStart: var uint64; clipStop: var uint64): bool =
...
proc parseBufferingRange*(self: Query; format: var Format; start: var int64;
    stop: var int64; estimatedTotal: var int64) =
...
proc parseConvert*(self: Query; srcFormat: var Format; srcValue: var int64;
    destFormat: var Format; destValue: var int64) =
...
proc parseDuration*(self: Query; format: var Format; duration: var int64) =
...
proc parseNthFormat*(self: Query; nth: int; format: var Format) =
...
proc parsePosition*(self: Query; format: var Format; cur: var int64) =
...
proc parseSeeking*(self: Query; format: var Format; seekable: var bool;
    segmentStart: var int64; segmentEnd: var int64) =
  var seekable_00 = gboolean(seekable)
...
proc parseSegment*(self: Query; rate: var cdouble; format: var Format;
    startValue: var int64; stopValue: var int64) =
...
proc gst_query_set_formatsv(self: ptr Query00; nFormats: int32; formats: FormatArray) {.
    importc, libprag.}

proc setFormatsv*(self: Query; nFormats: int; formats: FormatArray) =
...
proc doSeek*(self: Segment; rate: cdouble; format: Format; flags: SeekFlags;
    startType: SeekType; start: uint64; stopType: SeekType; stop: uint64; update: var bool): bool =
  var update_00 = gboolean(update)
...
proc newEventCustom*(`type`: EventType; structure: Structure): Event =
  let impl0 = gst_event_new_custom(`type`, cast[ptr Structure00](structure.impl))
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstEvent)
  result.impl = impl0
...
proc newEventNavigation*(structure: Structure): Event =
  fnew(result, gBoxedFreeGstEvent)
  result.impl = gst_event_new_navigation(cast[ptr Structure00](structure.impl))
...
proc gst_event_new_select_streams(streams: ptr pointer): ptr Event00 {.
    importc, libprag.}

proc newEventSelectStreams*(streams: ptr pointer): Event =
  fnew(result, gBoxedFreeGstEvent)
  result.impl = gst_event_new_select_streams(streams)

proc newEventSelectStreams*(tdesc: typedesc; streams: ptr pointer): tdesc =
  assert(result is Event)
  fnew(result, gBoxedFreeGstEvent)
  result.impl = gst_event_new_select_streams(streams)

proc initEventSelectStreams*[T](result: var T; streams: ptr pointer) {.deprecated.} =
  assert(result is Event)
  fnew(result, gBoxedFreeGstEvent)
  result.impl = gst_event_new_select_streams(streams)
...
proc newEventTag*(taglist: TagList): Event =
  fnew(result, gBoxedFreeGstEvent)
  result.impl = gst_event_new_tag(cast[ptr TagList00](taglist.impl))
...
proc parseFlushStop*(self: Event; resetTime: var bool) =
  var resetTime_00 = gboolean(resetTime)
...
proc parseGap*(self: Event; timestamp: var uint64; duration: var uint64) =
...
proc parseProtection*(self: Event; systemId: var string; data: var Buffer;
    origin: var string) =
  fnew(data, gBoxedFreeGstBuffer)
  data.ignoreFinalizer = true
  var origin_00 = cstring(origin)
  var systemId_00 = cstring(systemId)
  gst_event_parse_protection(cast[ptr Event00](self.impl), systemId_00, cast[var ptr Buffer00](addr data.impl), origin_00)
  origin = $(origin_00)
...
proc parseSegmentDone*(self: Event; format: var Format; position: var int64) =
  gst_event_parse_segment_done(cast[ptr Event00](self.impl), format, position)

proc gst_event_parse_select_streams(self: ptr Event00; streams: var ptr pointer) {.
    importc, libprag.}

proc parseSelectStreams*(self: Event; streams: var ptr pointer) =
  gst_event_parse_select_streams(cast[ptr Event00](self.impl), streams)
...
proc parseStep*(self: Event; format: var Format; amount: var uint64;
    rate: var cdouble; flush: var bool; intermediate: var bool) =
  var intermediate_00 = gboolean(intermediate)
  var flush_00 = gboolean(flush)
...
proc parseStream*(self: Event; stream: var Stream) =
  ...
  gst_event_parse_stream(cast[ptr Event00](self.impl), cast[var ptr Stream00](addr stream.impl))
...
proc parseStreamStart*(self: Event; streamId: var string) =
  var streamId_00 = cstring(streamId)
...
proc parseTocSelect*(self: Event; uid: var string) =
  var uid_00 = cstring(uid)
...
proc eventDefault*(self: Pad; parent: Object = nil; event: Event): bool =
  toBool(gst_pad_event_default(cast[ptr Pad00](self.impl), if parent.isNil: nil else: cast[ptr Object00](parent.impl), cast[ptr Event00](event.impl)))
...
proc stickyEvent*(self: Pad; eventType: EventType; idx: int): Event =
  let impl0 = gst_pad_get_sticky_event(cast[ptr Pad00](self.impl), eventType, uint32(idx))
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstEvent)
...
proc pushEvent*(self: Pad; event: Event): bool =
  toBool(gst_pad_push_event(cast[ptr Pad00](self.impl), cast[ptr Event00](event.impl)))

proc gst_pad_send_event(self: ptr Pad00; event: ptr Event00): gboolean {.
    importc, libprag.}

proc sendEvent*(self: Pad; event: Event): bool =
  toBool(gst_pad_send_event(cast[ptr Pad00](self.impl), cast[ptr Event00](event.impl)))
...
proc sendEvent*(self: Element; event: Event): bool =
  toBool(gst_element_send_event(cast[ptr Element00](self.impl), cast[ptr Event00](event.impl)))
...
proc newStreamCollection*(upstreamId: cstring = ""): StreamCollection =
  let gobj = gst_stream_collection_new(safeStringToCString(upstreamId))
  let qdata = g_object_get_qdata(gobj, Quark)
  if qdata != nil:
    result = cast[type(result)](qdata)
    assert(result.impl == gobj)
...
proc newStreamCollection*(tdesc: typedesc; upstreamId: cstring = ""): tdesc =
...
proc initStreamCollection*[T](result: var T; upstreamId: cstring = "") {.deprecated.} =
  assert(result is StreamCollection)
  let gobj = gst_stream_collection_new(safeStringToCString(upstreamId))
  let qdata = g_object_get_qdata(gobj, Quark)
  if qdata != nil:
...
proc addStream*(self: StreamCollection; stream: Stream): bool =
  toBool(gst_stream_collection_add_stream(cast[ptr StreamCollection00](self.impl), cast[ptr Stream00](stream.impl)))
...
proc stream*(self: StreamCollection; index: int): Stream =
  let gobj = gst_stream_collection_get_stream(cast[ptr StreamCollection00](self.impl), uint32(index))
  if gobj.isNil:
    return nil
  let qdata = g_object_get_qdata(gobj, Quark)
...
proc getUpstreamId*(self: StreamCollection): string =
  result = $gst_stream_collection_get_upstream_id(cast[ptr StreamCollection00](self.impl))
...
proc parseStreamCollection*(self: Event; collection: var StreamCollection) =
  ...
  gst_event_parse_stream_collection(cast[ptr Event00](self.impl), cast[var ptr StreamCollection00](addr collection.impl))
...
proc gst_toc_get_entries(self: ptr Toc00): ptr pointer {.
    importc, libprag.}

proc getEntries*(self: Toc): ptr pointer =
  gst_toc_get_entries(cast[ptr Toc00](self.impl))

proc entries*(self: Toc): ptr pointer =
  gst_toc_get_entries(cast[ptr Toc00](self.impl))
...
proc setTags*(self: Toc; tags: TagList = nil) =
  gst_toc_set_tags(cast[ptr Toc00](self.impl), if tags.isNil: nil else: cast[ptr TagList00](tags.impl))
...
proc parseToc*(self: Event; toc: var Toc; updated: var bool) =
  ...
  var updated_00 = gboolean(updated)
...
proc appendSubEntry*(self: TocEntry; subentry: TocEntry) =
  gst_toc_entry_append_sub_entry(cast[ptr TocEntry00](self.impl), cast[ptr TocEntry00](subentry.impl))
...
proc getStartStopTimes*(self: TocEntry; start: var int64;
    stop: var int64): bool =
  toBool(gst_toc_entry_get_start_stop_times(cast[ptr TocEntry00](self.impl), start, stop))

proc startStopTimes*(self: TocEntry; start: var int64;
    stop: var int64): bool =
  toBool(gst_toc_entry_get_start_stop_times(cast[ptr TocEntry00](self.impl), start, stop))

proc gst_toc_entry_get_sub_entries(self: ptr TocEntry00): ptr pointer {.
    importc, libprag.}

proc getSubEntries*(self: TocEntry): ptr pointer =
  gst_toc_entry_get_sub_entries(cast[ptr TocEntry00](self.impl))

proc subEntries*(self: TocEntry): ptr pointer =
  gst_toc_entry_get_sub_entries(cast[ptr TocEntry00](self.impl))
...
proc setTags*(self: TocEntry; tags: TagList = nil) =
  gst_toc_entry_set_tags(cast[ptr TocEntry00](self.impl), if tags.isNil: nil else: cast[ptr TagList00](tags.impl))
...
proc appendEntry*(self: Toc; entry: TocEntry) =
  gst_toc_append_entry(cast[ptr Toc00](self.impl), cast[ptr TocEntry00](entry.impl))
...
proc getLoop*(self: TocEntry; loopType: var TocLoopType; repeatCount: var int): bool =
  var repeatCount_00 = int32(repeatCount)
  result = toBool(gst_toc_entry_get_loop(cast[ptr TocEntry00](self.impl), loopType, repeatCount_00))
  repeatCount = int(repeatCount_00)

proc loop*(self: TocEntry; loopType: var TocLoopType; repeatCount: var int): bool =
  var repeatCount_00 = int32(repeatCount)
  result = toBool(gst_toc_entry_get_loop(cast[ptr TocEntry00](self.impl), loopType, repeatCount_00))
  repeatCount = int(repeatCount_00)
...
proc addObservationUnapplied*(self: Clock; slave: uint64; master: uint64;
    rSquared: var cdouble; internal: var uint64; external: var uint64; rateNum: var uint64;
    rateDenom: var uint64): bool =
...
proc getCalibration*(self: Clock; internal: var uint64; external: var uint64;
    rateNum: var uint64; rateDenom: var uint64) =
...
proc `master=`*(self: Clock; master: Clock = nil): bool =
  toBool(gst_clock_set_master(cast[ptr Clock00](self.impl), if master.isNil: nil else: cast[ptr Clock00](master.impl)))
...
proc `resolution=`*(self: Clock; resolution: uint64): uint64 =
  gst_clock_set_resolution(cast[ptr Clock00](self.impl), resolution)
...
proc `clock=`*(self: Element; clock: Clock = nil): bool =
  toBool(gst_element_set_clock(cast[ptr Element00](self.impl), if clock.isNil: nil else: cast[ptr Clock00](clock.impl)))
...
proc getContext*(self: Element; contextType: cstring): Context =
  fnew(result, gBoxedFreeGstContext)
  result.impl = gst_element_get_context(cast[ptr Element00](self.impl), contextType)

proc context*(self: Element; contextType: cstring): Context =
  fnew(result, gBoxedFreeGstContext)
  result.impl = gst_element_get_context(cast[ptr Element00](self.impl), contextType)
...
proc contextUnlocked*(self: Element; contextType: cstring): Context =
  let impl0 = gst_element_get_context_unlocked(cast[ptr Element00](self.impl), contextType)
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstContext)
...
proc getState*(self: Element; state: var State; pending: var State;
    timeout: uint64): StateChangeReturn =
  gst_element_get_state(cast[ptr Element00](self.impl), state, pending, timeout)

proc state*(self: Element; state: var State; pending: var State;
    timeout: uint64): StateChangeReturn =
  gst_element_get_state(cast[ptr Element00](self.impl), state, pending, timeout)
...
proc `state=`*(self: Element; state: State): StateChangeReturn =
  gst_element_set_state(cast[ptr Element00](self.impl), state)
...
proc newPad*(name: cstring = ""; direction: PadDirection): Pad =
  let gobj = gst_pad_new(safeStringToCString(name), direction)
  let qdata = g_object_get_qdata(gobj, Quark)
  if qdata != nil:
    result = cast[type(result)](qdata)
    assert(result.impl == gobj)
...
proc newPad*(tdesc: typedesc; name: cstring = ""; direction: PadDirection): tdesc =
  assert(result is Pad)
  let gobj = gst_pad_new(safeStringToCString(name), direction)
  let qdata = g_object_get_qdata(gobj, Quark)
  if qdata != nil:
...
proc initPad*[T](result: var T; name: cstring = ""; direction: PadDirection) {.deprecated.} =
  assert(result is Pad)
  let gobj = gst_pad_new(safeStringToCString(name), direction)
  let qdata = g_object_get_qdata(gobj, Quark)
  if qdata != nil:
...
proc gst_element_factory_list_filter(list: ptr pointer; caps: ptr Caps00;
    direction: PadDirection; subsetonly: gboolean): ptr pointer {.
    importc, libprag.}

proc listFilter*(list: ptr pointer; caps: Caps; direction: PadDirection;
    subsetonly: bool): ptr pointer =
  gst_element_factory_list_filter(list, cast[ptr Caps00](caps.impl), direction, gboolean(subsetonly))
...
proc newPipeline*(name: cstring = ""): Pipeline =
  let gobj = gst_pipeline_new(safeStringToCString(name))
  let qdata = g_object_get_qdata(gobj, Quark)
  if qdata != nil:
    result = cast[type(result)](qdata)
    assert(result.impl == gobj)
...
proc newPipeline*(tdesc: typedesc; name: cstring = ""): tdesc =
...
proc initPipeline*[T](result: var T; name: cstring = "") {.deprecated.} =
  assert(result is Pipeline)
  let gobj = gst_pipeline_new(safeStringToCString(name))
  let qdata = g_object_get_qdata(gobj, Quark)
  if qdata != nil:
...
proc childByIndex*(self: ChildProxy | Pipeline | Bin;
    index: int): gobject.Object =
  let gobj = gst_child_proxy_get_child_by_index(cast[ptr ChildProxy00](self.impl), uint32(index))
  if gobj.isNil:
    return nil
...
proc childByName*(self: ChildProxy | Pipeline | Bin;
    name: cstring): gobject.Object =
  let gobj = gst_child_proxy_get_child_by_name(cast[ptr ChildProxy00](self.impl), name)
  if gobj.isNil:
    return nil
...
proc lookup*(self: ChildProxy | Pipeline | Bin; name: cstring;
    target: var gobject.Object; pspec: var gobject.ParamSpec): bool =
  fnew(target, gobject.finalizeGObject)
  fnew(pspec, gobject.finalizeGObject)
  pspec.ignoreFinalizer = true
  toBool(gst_child_proxy_lookup(cast[ptr ChildProxy00](self.impl), name, cast[var ptr gobject.Object00](addr target.impl), cast[var ptr gobject.ParamSpec00](addr pspec.impl)))
...
proc gst_control_source_get_value_array(self: ptr ControlSource00; timestamp: uint64;
    interval: uint64; nValues: uint32; values: cdoubleArray): gboolean {.
    importc, libprag.}

proc controlSourceGetValueArray*(self: ControlSource; timestamp: uint64;
    interval: uint64; nValues: int; values: cdoubleArray): bool =
...
proc createElement*(self: Device; name: cstring = ""): Element =
  let gobj = gst_device_create_element(cast[ptr Device00](self.impl), safeStringToCString(name))
  if gobj.isNil:
    return nil
  let qdata = g_object_get_qdata(gobj, Quark)
  if qdata != nil:
...
proc gst_device_has_classesv(self: ptr Device00; classes: cstringArray): gboolean {.
    importc, libprag.}
...
proc addFilter*(self: DeviceMonitor; classes: cstring = "";
    caps: Caps = nil): int =
  int(gst_device_monitor_add_filter(cast[ptr DeviceMonitor00](self.impl), safeStringToCString(classes), if caps.isNil: nil else: cast[ptr Caps00](caps.impl)))

proc gst_device_monitor_get_devices(self: ptr DeviceMonitor00): ptr pointer {.
    importc, libprag.}

proc getDevices*(self: DeviceMonitor): ptr pointer =
  gst_device_monitor_get_devices(cast[ptr DeviceMonitor00](self.impl))

proc devices*(self: DeviceMonitor): ptr pointer =
  gst_device_monitor_get_devices(cast[ptr DeviceMonitor00](self.impl))

proc gst_device_monitor_get_providers(self: ptr DeviceMonitor00): cstringArray {.
    importc, libprag.}
...
proc gst_device_provider_get_devices(self: ptr DeviceProvider00): ptr pointer {.
    importc, libprag.}

proc getDevices*(self: DeviceProvider): ptr pointer =
  gst_device_provider_get_devices(cast[ptr DeviceProvider00](self.impl))

proc devices*(self: DeviceProvider): ptr pointer =
  gst_device_provider_get_devices(cast[ptr DeviceProvider00](self.impl))

proc gst_device_provider_get_hidden_providers(self: ptr DeviceProvider00): cstringArray {.
    importc, libprag.}
...
proc metadata*(self: DeviceProvider; key: cstring): string =
  result = $gst_device_provider_get_metadata(cast[ptr DeviceProvider00](self.impl), key)
...
proc listGetDeviceProviders*(minrank: Rank): ptr pointer {.
    importc: "gst_device_provider_factory_list_get_device_providers", libprag.}
...
proc metadata*(self: DeviceProviderFactory;
    key: cstring): string =
  let resul0 = gst_device_provider_factory_get_metadata(cast[ptr DeviceProviderFactory00](self.impl), key)
  if resul0.isNil:
    return
...
proc gst_device_provider_factory_get_metadata_keys(self: ptr DeviceProviderFactory00): cstringArray {.
    importc, libprag.}
...
proc hasClasses*(self: DeviceProviderFactory;
    classes: cstring = ""): bool =
  toBool(gst_device_provider_factory_has_classes(cast[ptr DeviceProviderFactory00](self.impl), safeStringToCString(classes)))

proc gst_device_provider_factory_has_classesv(self: ptr DeviceProviderFactory00;
    classes: cstringArray): gboolean {.
    importc, libprag.}
...
proc chainDefault*(pad: Pad; parent: Object = nil; buffer: Buffer): FlowReturn =
  gst_proxy_pad_chain_default(cast[ptr Pad00](pad.impl), if parent.isNil: nil else: cast[ptr Object00](parent.impl), cast[ptr Buffer00](buffer.impl))
...
proc chainListDefault*(pad: Pad; parent: Object = nil; list: BufferList): FlowReturn =
  gst_proxy_pad_chain_list_default(cast[ptr Pad00](pad.impl), if parent.isNil: nil else: cast[ptr Object00](parent.impl), cast[ptr BufferList00](list.impl))
...
proc rangeDefault*(pad: Pad; parent: Object; offset: uint64;
    size: int; buffer: var Buffer): FlowReturn =
  fnew(buffer, gBoxedFreeGstBuffer)
  gst_proxy_pad_getrange_default(cast[ptr Pad00](pad.impl), cast[ptr Object00](parent.impl), offset, uint32(size), cast[var ptr Buffer00](addr buffer.impl))
...
proc newGhostPad*(name: cstring = ""; target: Pad): GhostPad =
  let gobj = gst_ghost_pad_new(safeStringToCString(name), cast[ptr Pad00](target.impl))
  if gobj.isNil:
    return nil
  let qdata = g_object_get_qdata(gobj, Quark)
  if qdata != nil:
...
proc newGhostPad*(tdesc: typedesc; name: cstring = ""; target: Pad): tdesc =
...
proc initGhostPad*[T](result: var T; name: cstring = ""; target: Pad) {.deprecated.} =
  assert(result is GhostPad)
  let gobj = gst_ghost_pad_new(safeStringToCString(name), cast[ptr Pad00](target.impl))
  if gobj.isNil:
    return nil
...
proc newGhostPadFromTemplate*(name: cstring = ""; target: Pad; templ: PadTemplate): GhostPad =
  let gobj = gst_ghost_pad_new_from_template(safeStringToCString(name), cast[ptr Pad00](target.impl), cast[ptr PadTemplate00](templ.impl))
  if gobj.isNil:
    return nil
  let qdata = g_object_get_qdata(gobj, Quark)
  if qdata != nil:
...
proc newGhostPadFromTemplate*(tdesc: typedesc; name: cstring = ""; target: Pad; templ: PadTemplate): tdesc =
  assert(result is GhostPad)
  let gobj = gst_ghost_pad_new_from_template(safeStringToCString(name), cast[ptr Pad00](target.impl), cast[ptr PadTemplate00](templ.impl))
  if gobj.isNil:
    return nil
...
proc initGhostPadFromTemplate*[T](result: var T; name: cstring = ""; target: Pad; templ: PadTemplate) {.deprecated.} =
  assert(result is GhostPad)
  let gobj = gst_ghost_pad_new_from_template(safeStringToCString(name), cast[ptr Pad00](target.impl), cast[ptr PadTemplate00](templ.impl))
  if gobj.isNil:
    return nil
...
proc newGhostPadNoTarget*(name: cstring = ""; dir: PadDirection): GhostPad =
  let gobj = gst_ghost_pad_new_no_target(safeStringToCString(name), dir)
  if gobj.isNil:
    return nil
  let qdata = g_object_get_qdata(gobj, Quark)
  if qdata != nil:
...
proc newGhostPadNoTarget*(tdesc: typedesc; name: cstring = ""; dir: PadDirection): tdesc =
  assert(result is GhostPad)
  let gobj = gst_ghost_pad_new_no_target(safeStringToCString(name), dir)
  if gobj.isNil:
    return nil
...
proc initGhostPadNoTarget*[T](result: var T; name: cstring = ""; dir: PadDirection) {.deprecated.} =
  assert(result is GhostPad)
  let gobj = gst_ghost_pad_new_no_target(safeStringToCString(name), dir)
  if gobj.isNil:
    return nil
...
proc newGhostPadNoTargetFromTemplate*(name: cstring = ""; templ: PadTemplate): GhostPad =
  let gobj = gst_ghost_pad_new_no_target_from_template(safeStringToCString(name), cast[ptr PadTemplate00](templ.impl))
  if gobj.isNil:
    return nil
  let qdata = g_object_get_qdata(gobj, Quark)
  if qdata != nil:
...
proc newGhostPadNoTargetFromTemplate*(tdesc: typedesc; name: cstring = ""; templ: PadTemplate): tdesc =
  assert(result is GhostPad)
  let gobj = gst_ghost_pad_new_no_target_from_template(safeStringToCString(name), cast[ptr PadTemplate00](templ.impl))
  if gobj.isNil:
    return nil
...
proc initGhostPadNoTargetFromTemplate*[T](result: var T; name: cstring = ""; templ: PadTemplate) {.deprecated.} =
  assert(result is GhostPad)
  let gobj = gst_ghost_pad_new_no_target_from_template(safeStringToCString(name), cast[ptr PadTemplate00](templ.impl))
  if gobj.isNil:
    return nil
...
proc `target=`*(self: GhostPad; newtarget: Pad = nil): bool =
  toBool(gst_ghost_pad_set_target(cast[ptr GhostPad00](self.impl), if newtarget.isNil: nil else: cast[ptr Pad00](newtarget.impl)))
...
type
  MemoryMapFullFunction* = proc (mem: ptr Memory00; info: ptr MapInfo00; maxsize: uint64): pointer {.cdecl.}
...
type
  MemoryUnmapFullFunction* = proc (mem: ptr Memory00; info: ptr MapInfo00) {.cdecl.}
...
proc newMessageApplication*(src: Object = nil; structure: Structure): Message =
  let impl0 = gst_message_new_application(if src.isNil: nil else: cast[ptr Object00](src.impl), cast[ptr Structure00](structure.impl))
  if impl0.isNil:
    return nil
...
proc newMessageCustom*(`type`: MessageType; src: Object = nil; structure: Structure = nil): Message =
  let impl0 = gst_message_new_custom(`type`, if src.isNil: nil else: cast[ptr Object00](src.impl), if structure.isNil: nil else: cast[ptr Structure00](structure.impl))
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstMessage)
  result.impl = impl0
...
proc newMessageElement*(src: Object = nil; structure: Structure): Message =
  let impl0 = gst_message_new_element(if src.isNil: nil else: cast[ptr Object00](src.impl), cast[ptr Structure00](structure.impl))
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstMessage)
  result.impl = impl0
...
proc newMessageErrorWithDetails*(src: Object = nil; error: ptr glib.Error;
  ...
  let impl0 = gst_message_new_error_with_details(if src.isNil: nil else: cast[ptr Object00](src.impl), error, debug, if details.isNil: nil else: cast[ptr Structure00](details.impl))
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstMessage)
  result.impl = impl0
...
proc newMessageHaveContext*(src: Object = nil; context: Context): Message =
  fnew(result, gBoxedFreeGstMessage)
  result.impl = gst_message_new_have_context(if src.isNil: nil else: cast[ptr Object00](src.impl), cast[ptr Context00](context.impl))
...
proc newMessageInfoWithDetails*(src: Object = nil; error: ptr glib.Error;
    debug: cstring; details: Structure = nil): Message =
  let impl0 = gst_message_new_info_with_details(if src.isNil: nil else: cast[ptr Object00](src.impl), error, debug, if details.isNil: nil else: cast[ptr Structure00](details.impl))
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstMessage)
  result.impl = impl0
...
proc newMessagePropertyNotify*(src: Object; propertyName: cstring;
    val: gobject.Value = cast[ptr gobject.Value](nil)[]): Message =
  fnew(result, gBoxedFreeGstMessage)
...
proc newMessagePropertyNotify*(tdesc: typedesc; src: Object; propertyName: cstring;
    val: gobject.Value = cast[ptr gobject.Value](nil)[]): tdesc =
  assert(result is Message)
  fnew(result, gBoxedFreeGstMessage)
  result.impl = gst_message_new_property_notify(cast[ptr Object00](src.impl), propertyName, val)

proc initMessagePropertyNotify*[T](result: var T; src: Object; propertyName: cstring;
    val: gobject.Value = cast[ptr gobject.Value](nil)[]) {.deprecated.} =
  assert(result is Message)
  fnew(result, gBoxedFreeGstMessage)
  result.impl = gst_message_new_property_notify(cast[ptr Object00](src.impl), propertyName, val)
...
proc newMessageRedirect*(src: Object; location: cstring; tagList: TagList = nil;
  ...
  fnew(result, gBoxedFreeGstMessage)
  result.impl = gst_message_new_redirect(cast[ptr Object00](src.impl), location, if tagList.isNil: nil else: cast[ptr TagList00](tagList.impl), if entryStruct.isNil: nil else: cast[ptr Structure00](entryStruct.impl))
...
proc newMessageTag*(src: Object = nil; tagList: TagList): Message =
  fnew(result, gBoxedFreeGstMessage)
  result.impl = gst_message_new_tag(if src.isNil: nil else: cast[ptr Object00](src.impl), cast[ptr TagList00](tagList.impl))
...
proc newMessageWarningWithDetails*(src: Object = nil; error: ptr glib.Error;
    debug: cstring; details: Structure = nil): Message =
  let impl0 = gst_message_new_warning_with_details(if src.isNil: nil else: cast[ptr Object00](src.impl), error, debug, if details.isNil: nil else: cast[ptr Structure00](details.impl))
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstMessage)
  result.impl = impl0
...
proc addRedirectEntry*(self: Message; location: cstring; tagList: TagList = nil;
  ...
  gst_message_add_redirect_entry(cast[ptr Message00](self.impl), location, if tagList.isNil: nil else: cast[ptr TagList00](tagList.impl), if entryStruct.isNil: nil else: cast[ptr Structure00](entryStruct.impl))
...
proc parseAsyncDone*(self: Message; runningTime: var uint64) =
...
proc parseBuffering*(self: Message; percent: var int) =
  var percent_00 = int32(percent)
...
proc parseBufferingStats*(self: Message; mode: var BufferingMode;
    avgIn: var int; avgOut: var int; bufferingLeft: var int64) =
  var avgOut_00 = int32(avgOut)
  var avgIn_00 = int32(avgIn)
...
proc parseClockLost*(self: Message; clock: var Clock) =
  fnew(clock, gst.finalizeGObject)
  clock.ignoreFinalizer = true
  gst_message_parse_clock_lost(cast[ptr Message00](self.impl), cast[var ptr Clock00](addr clock.impl))

proc gst_message_parse_clock_provide(self: ptr Message00; clock: var ptr Clock00;
    ready: var gboolean) {.
    importc, libprag.}

proc parseClockProvide*(self: Message; clock: var Clock; ready: var bool) =
  fnew(clock, gst.finalizeGObject)
  clock.ignoreFinalizer = true
  var ready_00 = gboolean(ready)
  gst_message_parse_clock_provide(cast[ptr Message00](self.impl), cast[var ptr Clock00](addr clock.impl), ready_00)
  ready = toBool(ready_00)

proc gst_message_parse_context_type(self: ptr Message00; contextType: var cstring): gboolean {.
    importc, libprag.}

proc parseContextType*(self: Message; contextType: var string): bool =
  var contextType_00 = cstring(contextType)
...
proc parseDeviceAdded*(self: Message; device: var Device) =
  fnew(device, gst.finalizeGObject)
  gst_message_parse_device_added(cast[ptr Message00](self.impl), cast[var ptr Device00](addr device.impl))

proc gst_message_parse_device_changed(self: ptr Message00; device: var ptr Device00;
    changedDevice: var ptr Device00) {.
    importc, libprag.}

proc parseDeviceChanged*(self: Message; device: var Device;
    changedDevice: var Device) =
  fnew(device, gst.finalizeGObject)
  fnew(changedDevice, gst.finalizeGObject)
  gst_message_parse_device_changed(cast[ptr Message00](self.impl), cast[var ptr Device00](addr device.impl), cast[var ptr Device00](addr changedDevice.impl))

proc gst_message_parse_device_removed(self: ptr Message00; device: var ptr Device00) {.
    importc, libprag.}

proc parseDeviceRemoved*(self: Message; device: var Device) =
  fnew(device, gst.finalizeGObject)
  gst_message_parse_device_removed(cast[ptr Message00](self.impl), cast[var ptr Device00](addr device.impl))

proc gst_message_parse_error(self: ptr Message00; gerror: var ptr glib.Error;
    debug: var cstring) {.
    importc, libprag.}

proc parseError*(self: Message; gerror: var ptr glib.Error; debug: var string) =
  var debug_00 = cstring(debug)
...
proc parseGroupId*(self: Message; groupId: var int): bool =
  var groupId_00 = uint32(groupId)
...
proc parseHaveContext*(self: Message; context: var Context) =
  fnew(context, gBoxedFreeGstContext)
  gst_message_parse_have_context(cast[ptr Message00](self.impl), cast[var ptr Context00](addr context.impl))

proc gst_message_parse_info(self: ptr Message00; gerror: var ptr glib.Error;
    debug: var cstring) {.
    importc, libprag.}

proc parseInfo*(self: Message; gerror: var ptr glib.Error; debug: var string) =
  var debug_00 = cstring(debug)
...
proc parseNewClock*(self: Message; clock: var Clock) =
  fnew(clock, gst.finalizeGObject)
  clock.ignoreFinalizer = true
  gst_message_parse_new_clock(cast[ptr Message00](self.impl), cast[var ptr Clock00](addr clock.impl))
...
proc parsePropertyNotify*(self: Message; `object`: var Object;
    propertyName: var string; propertyValue: var gobject.Value) =
  fnew(`object`, gst.finalizeGObject)
  `object`.ignoreFinalizer = true
  var propertyName_00 = cstring(propertyName)
  gst_message_parse_property_notify(cast[ptr Message00](self.impl), cast[var ptr Object00](addr `object`.impl), propertyName_00, propertyValue)
...
proc parseQos*(self: Message; live: var bool; runningTime: var uint64;
    streamTime: var uint64; timestamp: var uint64; duration: var uint64) =
  var live_00 = gboolean(live)
...
proc parseQosStats*(self: Message; format: var Format; processed: var uint64;
    dropped: var uint64) =
...
proc parseQosValues*(self: Message; jitter: var int64; proportion: var cdouble;
    quality: var int) =
  var quality_00 = int32(quality)
...
proc parseRedirectEntry*(self: Message; entryIndex: uint64;
    location: var string; tagList: var TagList; entryStruct: var Structure) =
  fnew(tagList, gBoxedFreeGstTagList)
  tagList.ignoreFinalizer = true
  fnew(entryStruct, gBoxedFreeGstStructure)
  entryStruct.ignoreFinalizer = true
  var location_00 = cstring(location)
  gst_message_parse_redirect_entry(cast[ptr Message00](self.impl), entryIndex, location_00, cast[var ptr TagList00](addr tagList.impl), cast[var ptr Structure00](addr entryStruct.impl))
  location = $(location_00)

proc gst_message_parse_request_state(self: ptr Message00; state: var State) {.
    importc, libprag.}

proc parseRequestState*(self: Message; state: var State) =
...
proc parseResetTime*(self: Message; runningTime: var uint64) =
...
proc parseSegmentDone*(self: Message; format: var Format; position: var int64) =
...
proc parseSegmentStart*(self: Message; format: var Format; position: var int64) =
...
proc parseStateChanged*(self: Message; oldstate: var State;
    newstate: var State; pending: var State) =
...
proc parseStepDone*(self: Message; format: var Format; amount: var uint64;
    rate: var cdouble; flush: var bool; intermediate: var bool; duration: var uint64;
    eos: var bool) =
  var intermediate_00 = gboolean(intermediate)
  var flush_00 = gboolean(flush)
  var eos_00 = gboolean(eos)
...
proc parseStepStart*(self: Message; active: var bool; format: var Format;
    amount: var uint64; rate: var cdouble; flush: var bool; intermediate: var bool) =
  var intermediate_00 = gboolean(intermediate)
  var flush_00 = gboolean(flush)
  var active_00 = gboolean(active)
...
proc parseStreamCollection*(self: Message; collection: var StreamCollection) =
  fnew(collection, gst.finalizeGObject)
  gst_message_parse_stream_collection(cast[ptr Message00](self.impl), cast[var ptr StreamCollection00](addr collection.impl))

proc gst_message_parse_streams_selected(self: ptr Message00; collection: var ptr StreamCollection00) {.
    importc, libprag.}

proc parseStreamsSelected*(self: Message; collection: var StreamCollection) =
  fnew(collection, gst.finalizeGObject)
  gst_message_parse_streams_selected(cast[ptr Message00](self.impl), cast[var ptr StreamCollection00](addr collection.impl))
...
proc parseWarning*(self: Message; gerror: var ptr glib.Error;
    debug: var string) =
  var debug_00 = cstring(debug)
...
proc gst_bus_get_pollfd(self: ptr Bus00; fd: var glib.PollFD00) {.
    importc, libprag.}

proc getPollfd*(self: Bus; fd: var glib.PollFD00) =
...
proc post*(self: Bus; message: Message): bool =
  toBool(gst_bus_post(cast[ptr Bus00](self.impl), cast[ptr Message00](message.impl)))
...
proc postMessage*(self: Element; message: Message): bool =
  toBool(gst_element_post_message(cast[ptr Element00](self.impl), cast[ptr Message00](message.impl)))
...
proc parseProgress*(self: Message; `type`: var ProgressType;
    code: var string; text: var string) =
  var code_00 = cstring(code)
...
proc parseStreamStatus*(self: Message; `type`: var StreamStatusType;
  ...
  owner.ignoreFinalizer = true
  gst_message_parse_stream_status(cast[ptr Message00](self.impl), `type`, cast[var ptr Element00](addr owner.impl))
...
proc parseStructureChange*(self: Message; `type`: var StructureChangeType;
    owner: var Element; busy: var bool) =
  fnew(owner, gst.finalizeGObject)
  owner.ignoreFinalizer = true
  var busy_00 = gboolean(busy)
  gst_message_parse_structure_change(cast[ptr Message00](self.impl), `type`, cast[var ptr Element00](addr owner.impl), busy_00)
  busy = toBool(busy_00)
...
proc finalizerfree*(self: ParseContext) =
  if not self.ignoreFinalizer:
    gst_parse_context_free(self.impl)
...
proc gst_parse_context_get_missing_elements(self: ptr ParseContext00): cstringArray {.
    importc, libprag.}
...
proc gst_poll_get_read_gpollfd(self: ptr Poll00; fd: ptr glib.PollFD00) {.
    importc, libprag.}

proc getReadGpollfd*(self: Poll; fd: glib.PollFD) =
  gst_poll_get_read_gpollfd(cast[ptr Poll00](self.impl), cast[ptr glib.PollFD00](fd.impl))
...
proc `controllable=`*(self: Poll; controllable: bool): bool =
  toBool(gst_poll_set_controllable(cast[ptr Poll00](self.impl), gboolean(controllable)))
...
proc gst_poll_fd_init(self: ptr PollFD00) {.
    importc, libprag.}

proc init*(self: PollFD) =
  gst_poll_fd_init(cast[ptr PollFD00](self.impl))

proc gst_poll_fd_can_read(self: ptr Poll00; fd: ptr PollFD00): gboolean {.
    importc, libprag.}

proc fdCanRead*(self: Poll; fd: PollFD): bool =
  toBool(gst_poll_fd_can_read(cast[ptr Poll00](self.impl), cast[ptr PollFD00](fd.impl)))

proc gst_poll_fd_can_write(self: ptr Poll00; fd: ptr PollFD00): gboolean {.
    importc, libprag.}

proc fdCanWrite*(self: Poll; fd: PollFD): bool =
  toBool(gst_poll_fd_can_write(cast[ptr Poll00](self.impl), cast[ptr PollFD00](fd.impl)))

proc gst_poll_fd_ctl_pri(self: ptr Poll00; fd: ptr PollFD00; active: gboolean): gboolean {.
    importc, libprag.}

proc fdCtlPri*(self: Poll; fd: PollFD; active: bool): bool =
  toBool(gst_poll_fd_ctl_pri(cast[ptr Poll00](self.impl), cast[ptr PollFD00](fd.impl), gboolean(active)))

proc gst_poll_fd_ctl_read(self: ptr Poll00; fd: ptr PollFD00; active: gboolean): gboolean {.
    importc, libprag.}

proc fdCtlRead*(self: Poll; fd: PollFD; active: bool): bool =
  toBool(gst_poll_fd_ctl_read(cast[ptr Poll00](self.impl), cast[ptr PollFD00](fd.impl), gboolean(active)))

proc gst_poll_fd_ctl_write(self: ptr Poll00; fd: ptr PollFD00; active: gboolean): gboolean {.
    importc, libprag.}

proc fdCtlWrite*(self: Poll; fd: PollFD; active: bool): bool =
  toBool(gst_poll_fd_ctl_write(cast[ptr Poll00](self.impl), cast[ptr PollFD00](fd.impl), gboolean(active)))

proc gst_poll_fd_has_closed(self: ptr Poll00; fd: ptr PollFD00): gboolean {.
    importc, libprag.}

proc fdHasClosed*(self: Poll; fd: PollFD): bool =
  toBool(gst_poll_fd_has_closed(cast[ptr Poll00](self.impl), cast[ptr PollFD00](fd.impl)))

proc gst_poll_fd_has_error(self: ptr Poll00; fd: ptr PollFD00): gboolean {.
    importc, libprag.}

proc fdHasError*(self: Poll; fd: PollFD): bool =
  toBool(gst_poll_fd_has_error(cast[ptr Poll00](self.impl), cast[ptr PollFD00](fd.impl)))

proc gst_poll_fd_has_pri(self: ptr Poll00; fd: ptr PollFD00): gboolean {.
    importc, libprag.}

proc fdHasPri*(self: Poll; fd: PollFD): bool =
  toBool(gst_poll_fd_has_pri(cast[ptr Poll00](self.impl), cast[ptr PollFD00](fd.impl)))

proc gst_poll_fd_ignored(self: ptr Poll00; fd: ptr PollFD00) {.
    importc, libprag.}

proc fdIgnored*(self: Poll; fd: PollFD) =
  gst_poll_fd_ignored(cast[ptr Poll00](self.impl), cast[ptr PollFD00](fd.impl))

proc gst_poll_add_fd(self: ptr Poll00; fd: ptr PollFD00): gboolean {.
    importc, libprag.}

proc addFd*(self: Poll; fd: PollFD): bool =
  toBool(gst_poll_add_fd(cast[ptr Poll00](self.impl), cast[ptr PollFD00](fd.impl)))

proc gst_poll_remove_fd(self: ptr Poll00; fd: ptr PollFD00): gboolean {.
    importc, libprag.}

proc removeFd*(self: Poll; fd: PollFD): bool =
  toBool(gst_poll_remove_fd(cast[ptr Poll00](self.impl), cast[ptr PollFD00](fd.impl)))
...
proc `appDir=`*(appDir: cstring): bool =
  toBool(gst_preset_set_app_dir(appDir))
...
proc meta*(self: Preset; name: cstring; tag: cstring; value: var string): bool =
  var value_00 = cstring(value)
  result = toBool(gst_preset_get_meta(cast[ptr Preset00](self.impl), name, tag, value_00))
  value = $(value_00)

proc gst_preset_get_preset_names(self: ptr Preset00): cstringArray {.
    importc, libprag.}
...
proc gst_preset_get_property_names(self: ptr Preset00): cstringArray {.
    importc, libprag.}
...
proc setMeta*(self: Preset; name: cstring; tag: cstring; value: cstring = ""): bool =
  toBool(gst_preset_set_meta(cast[ptr Preset00](self.impl), name, tag, safeStringToCString(value)))
...
proc getReply*(self: Promise): Structure =
  fnew(result, gBoxedFreeGstStructure)
  result.impl = gst_promise_get_reply(cast[ptr Promise00](self.impl))
  result.ignoreFinalizer = true
...
proc reply*(self: Promise; s: Structure) =
  gst_promise_reply(cast[ptr Promise00](self.impl), cast[ptr Structure00](s.impl))
...
proc gst_registry_feature_filter(self: ptr Registry00; filter: PluginFeatureFilter;
    first: gboolean; userData: pointer): ptr pointer {.
    importc, libprag.}

proc featureFilter*(self: Registry; filter: PluginFeatureFilter;
    first: bool; userData: pointer): ptr pointer =
  gst_registry_feature_filter(cast[ptr Registry00](self.impl), filter, gboolean(first), userData)
...
proc gst_registry_get_feature_list(self: ptr Registry00; `type`: GType): ptr pointer {.
    importc, libprag.}

proc getFeatureList*(self: Registry; `type`: GType): ptr pointer =
  gst_registry_get_feature_list(cast[ptr Registry00](self.impl), `type`)

proc featureList*(self: Registry; `type`: GType): ptr pointer =
  gst_registry_get_feature_list(cast[ptr Registry00](self.impl), `type`)

proc gst_registry_get_feature_list_by_plugin(self: ptr Registry00; name: cstring): ptr pointer {.
    importc, libprag.}

proc getFeatureListByPlugin*(self: Registry; name: cstring): ptr pointer =
  gst_registry_get_feature_list_by_plugin(cast[ptr Registry00](self.impl), name)

proc featureListByPlugin*(self: Registry; name: cstring): ptr pointer =
  gst_registry_get_feature_list_by_plugin(cast[ptr Registry00](self.impl), name)
...
proc gst_registry_get_plugin_list(self: ptr Registry00): ptr pointer {.
    importc, libprag.}

proc getPluginList*(self: Registry): ptr pointer =
  gst_registry_get_plugin_list(cast[ptr Registry00](self.impl))

proc pluginList*(self: Registry): ptr pointer =
  gst_registry_get_plugin_list(cast[ptr Registry00](self.impl))
...
proc pluginFilter*(self: Registry; filter: PluginFilter; first: bool;
    userData: pointer): ptr pointer =
  gst_registry_plugin_filter(cast[ptr Registry00](self.impl), filter, gboolean(first), userData)
...
type
  StackTraceFlags* {.size: sizeof(cint), pure.} = enum
    full = 1

type
  StaticCaps00* {.pure.} = object
  StaticCaps* = ref object
    impl*: ptr StaticCaps00
    ignoreFinalizer*: bool

proc gst_static_caps_cleanup(self: ptr StaticCaps00) {.
    importc, libprag.}

proc cleanup*(self: StaticCaps) =
  gst_static_caps_cleanup(cast[ptr StaticCaps00](self.impl))

proc gst_static_caps_get(self: ptr StaticCaps00): ptr Caps00 {.
    importc, libprag.}

proc getStaticCaps*(self: StaticCaps): Caps =
  let impl0 = gst_static_caps_get(cast[ptr StaticCaps00](self.impl))
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstCaps)
  result.impl = impl0
...
proc `default=`*(newClock: Clock = nil) =
  gst_system_clock_set_default(if newClock.isNil: nil else: cast[ptr Clock00](newClock.impl))
...
proc gst_task_set_lock(self: ptr Task00; mutex: ptr glib.RecMutex00) {.
    importc, libprag.}

proc setLock*(self: Task; mutex: glib.RecMutex) =
  gst_task_set_lock(cast[ptr Task00](self.impl), cast[ptr glib.RecMutex00](mutex.impl))
...
proc `state=`*(self: Task; state: TaskState): bool =
  toBool(gst_task_set_state(cast[ptr Task00](self.impl), state))
...
type
  TimedValue00* {.pure.} = object
  TimedValue* = ref object
    impl*: ptr TimedValue00
    ignoreFinalizer*: bool
...
proc getListTracerFactory*(): ptr pointer {.
    importc: "gst_tracer_factory_get_list", libprag.}

proc listTracerFactory*(): ptr pointer {.
    importc: "gst_tracer_factory_get_list", libprag.}
...
proc gst_type_find_peek(self: ptr TypeFind00; offset: int64; size: var uint32): uint8Array {.
    importc, libprag.}
...
proc getListTypeFindFactory*(): ptr pointer {.
    importc: "gst_type_find_factory_get_list", libprag.}

proc listTypeFindFactory*(): ptr pointer {.
    importc: "gst_type_find_factory_get_list", libprag.}
...
proc getCaps*(self: TypeFindFactory): Caps =
  fnew(result, gBoxedFreeGstCaps)
  result.impl = gst_type_find_factory_get_caps(cast[ptr TypeFindFactory00](self.impl))
  result.ignoreFinalizer = true
...
proc gst_type_find_factory_get_extensions(self: ptr TypeFindFactory00): cstringArray {.
    importc, libprag.}
...
proc registerTypeFind*(plugin: Plugin = nil; name: cstring; rank: int;
    `func`: TypeFindFunction; extensions: cstring = ""; possibleCaps: Caps;
    data: pointer; dataNotify: DestroyNotify): bool =
  toBool(gst_type_find_register(if plugin.isNil: nil else: cast[ptr Plugin00](plugin.impl), name, uint32(rank), `func`, safeStringToCString(extensions), cast[ptr Caps00](possibleCaps.impl), data, dataNotify))
...
proc gst_uri_handler_get_protocols(self: ptr URIHandler00): cstringArray {.
    importc, libprag.}
...
proc `uri=`*(self: URIHandler; uri: cstring): bool =
  var gerror: ptr glib.Error
  let resul0 = gst_uri_handler_set_uri(cast[ptr URIHandler00](self.impl), uri, addr gerror)
  if gerror != nil:
    let msg = $gerror.message
...
proc newUri*(scheme: cstring = ""; userinfo: cstring = ""; host: cstring = "";
    port: int; path: cstring = ""; query: cstring = ""; fragment: cstring = ""): Uri =
  fnew(result, gBoxedFreeGstUri)
  result.impl = gst_uri_new(safeStringToCString(scheme), safeStringToCString(userinfo), safeStringToCString(host), uint32(port), safeStringToCString(path), safeStringToCString(query), safeStringToCString(fragment))

proc newUri*(tdesc: typedesc; scheme: cstring = ""; userinfo: cstring = ""; host: cstring = "";
    port: int; path: cstring = ""; query: cstring = ""; fragment: cstring = ""): tdesc =
  assert(result is Uri)
  fnew(result, gBoxedFreeGstUri)
  result.impl = gst_uri_new(safeStringToCString(scheme), safeStringToCString(userinfo), safeStringToCString(host), uint32(port), safeStringToCString(path), safeStringToCString(query), safeStringToCString(fragment))

proc initUri*[T](result: var T; scheme: cstring = ""; userinfo: cstring = ""; host: cstring = "";
    port: int; path: cstring = ""; query: cstring = ""; fragment: cstring = "") {.deprecated.} =
  assert(result is Uri)
  fnew(result, gBoxedFreeGstUri)
  result.impl = gst_uri_new(safeStringToCString(scheme), safeStringToCString(userinfo), safeStringToCString(host), uint32(port), safeStringToCString(path), safeStringToCString(query), safeStringToCString(fragment))
...
proc gst_uri_get_path_segments(self: ptr Uri00): ptr pointer {.
    importc, libprag.}

proc getPathSegments*(self: Uri): ptr pointer =
  gst_uri_get_path_segments(cast[ptr Uri00](self.impl))

proc pathSegments*(self: Uri): ptr pointer =
  gst_uri_get_path_segments(cast[ptr Uri00](self.impl))
...
proc gst_uri_get_query_keys(self: ptr Uri00): ptr pointer {.
    importc, libprag.}

proc getQueryKeys*(self: Uri): ptr pointer =
  gst_uri_get_query_keys(cast[ptr Uri00](self.impl))

proc queryKeys*(self: Uri): ptr pointer =
  gst_uri_get_query_keys(cast[ptr Uri00](self.impl))
...
proc queryValue*(self: Uri; queryKey: cstring): string =
  let resul0 = gst_uri_get_query_value(cast[ptr Uri00](self.impl), queryKey)
  if resul0.isNil:
    return
  result = $resul0
...
proc makeWritable*(self: Uri): Uri =
  fnew(result, gBoxedFreeGstUri)
  result.impl = gst_uri_make_writable(cast[ptr Uri00](self.impl))
...
proc newUriWithBase*(self: Uri; scheme: cstring = ""; userinfo: cstring = "";
    host: cstring = ""; port: int; path: cstring = ""; query: cstring = "";
    fragment: cstring = ""): Uri =
  fnew(result, gBoxedFreeGstUri)
  result.impl = gst_uri_new_with_base(cast[ptr Uri00](self.impl), safeStringToCString(scheme), safeStringToCString(userinfo), safeStringToCString(host), uint32(port), safeStringToCString(path), safeStringToCString(query), safeStringToCString(fragment))
...
proc setFragment*(self: Uri; fragment: cstring = ""): bool =
  toBool(gst_uri_set_fragment(cast[ptr Uri00](self.impl), safeStringToCString(fragment)))

proc `fragment=`*(self: Uri; fragment: cstring = ""): bool =
  toBool(gst_uri_set_fragment(cast[ptr Uri00](self.impl), safeStringToCString(fragment)))
...
proc `host=`*(self: Uri; host: cstring): bool =
  toBool(gst_uri_set_host(cast[ptr Uri00](self.impl), host))
...
proc `path=`*(self: Uri; path: cstring): bool =
  toBool(gst_uri_set_path(cast[ptr Uri00](self.impl), path))

proc gst_uri_set_path_segments(self: ptr Uri00; pathSegments: ptr pointer): gboolean {.
    importc, libprag.}

proc setPathSegments*(self: Uri; pathSegments: ptr pointer): bool =
  toBool(gst_uri_set_path_segments(cast[ptr Uri00](self.impl), pathSegments))

proc `pathSegments=`*(self: Uri; pathSegments: ptr pointer): bool =
  toBool(gst_uri_set_path_segments(cast[ptr Uri00](self.impl), pathSegments))
...
proc `pathString=`*(self: Uri; path: cstring): bool =
  toBool(gst_uri_set_path_string(cast[ptr Uri00](self.impl), path))
...
proc `port=`*(self: Uri; port: int): bool =
  toBool(gst_uri_set_port(cast[ptr Uri00](self.impl), uint32(port)))
...
proc `queryString=`*(self: Uri; query: cstring): bool =
  toBool(gst_uri_set_query_string(cast[ptr Uri00](self.impl), query))
...
proc `queryTable=`*(self: Uri; queryTable: ptr HashTable00): bool =
  toBool(gst_uri_set_query_table(cast[ptr Uri00](self.impl), queryTable))

proc gst_uri_set_query_value(self: ptr Uri00; queryKey: cstring; queryValue: cstring): gboolean {.
    importc, libprag.}

proc setQueryValue*(self: Uri; queryKey: cstring; queryValue: cstring = ""): bool =
  toBool(gst_uri_set_query_value(cast[ptr Uri00](self.impl), queryKey, safeStringToCString(queryValue)))
...
proc `scheme=`*(self: Uri; scheme: cstring): bool =
  toBool(gst_uri_set_scheme(cast[ptr Uri00](self.impl), scheme))
...
proc `userinfo=`*(self: Uri; userinfo: cstring): bool =
  toBool(gst_uri_set_userinfo(cast[ptr Uri00](self.impl), userinfo))
...
proc valueValueArray*(value: gobject.Value; index: uint32): ptr gobject.Value {.
    importc: "gst_value_array_get_value", libprag.}
...
proc valueValueList*(value: gobject.Value; index: uint32): ptr gobject.Value {.
    importc: "gst_value_list_get_value", libprag.}
...
proc debugGetAllCategories*(): ptr pointer {.
...
proc gst_debug_ring_buffer_logger_get_logs(): cstringArray {.
    importc, libprag.}
...
proc gst_formats_contains(formats: FormatArray; format: Format): gboolean {.
    importc, libprag.}

proc formatsContains*(formats: FormatArray; format: Format): bool =
...
proc mainExecutablePath*(): string =
  let resul0 = gst_get_main_executable_path()
  if resul0.isNil:
    return
  result = $resul0

proc gst_init(argc: var int32; argv: var cstringArray) {.
    importc, libprag.}
...
proc gst_init_check(argc: var int32; argv: var cstringArray; error: ptr ptr glib.Error = nil): gboolean {.
    importc, libprag.}
...
proc gst_parse_launchv(argv: cstringArray; error: ptr ptr glib.Error = nil): ptr Element00 {.
    importc, libprag.}
...
proc gst_parse_launchv_full(argv: cstringArray; context: ptr ParseContext00;
    flags: ParseFlags; error: ptr ptr glib.Error = nil): ptr Element00 {.
    importc, libprag.}
...
proc gst_protection_filter_systems_by_available_decryptors(systemIdentifiers: cstringArray): cstringArray {.
    importc, libprag.}
...
proc gst_protection_select_system(systemIdentifiers: cstringArray): cstring {.
    importc, libprag.}
...
proc utilDoubleToFraction*(src: cdouble; destN: var int; destD: var int) =
  var destD_00 = int32(destD)
  var destN_00 = int32(destN)
...
proc gst_util_dump_mem(mem: uint8Array; size: uint32) {.
    importc, libprag.}

proc utilDumpMem*(mem: seq[uint8] | string) =
  let size = int(mem.len)
  gst_util_dump_mem(unsafeaddr(mem[0]), uint32(size))
...
proc utilFractionAdd*(aN: int; aD: int; bN: int; bD: int; resN: var int;
    resD: var int): bool =
  var resN_00 = int32(resN)
  var resD_00 = int32(resD)
...
proc valueIntersect*(dest: var gobject.Value; value1: gobject.Value;
    value2: gobject.Value): bool =
...
proc valueSubtract*(dest: var gobject.Value; minuend: gobject.Value;
    subtrahend: gobject.Value): bool =
