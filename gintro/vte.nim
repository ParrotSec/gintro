...
proc spawnAsync*(self: Pty; workingDirectory: cstring = ""; argv: openArray[string];
...
proc spawnAsync*(self: Terminal; ptyFlags: PtyFlags; workingDirectory: cstring = "";
    argv: openArray[string]; envv: openArray[string]; spawnFlags: glib.SpawnFlags;
