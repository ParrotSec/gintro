const
  SCA = [
    ...
    "enable_debugging!Window!1!(self: Window | PlugAccessible | WindowAccessible; toggle: bool): bool!(self: ptr Window00; toggle: gboolean): gboolean",
    "set_focus!Window!1!(self: Window | PlugAccessible | WindowAccessible; widget: Widget = nil)!(self: ptr Window00; widget: ptr Widget00)",
    ...
    "icon_press!Entry!2!(self: Entry; iconPos: EntryIconPosition; event: gdk.Event)!(self: ptr Entry00; iconPos: EntryIconPosition; event: ptr gdk.Event00)",
    "icon_release!Entry!2!(self: Entry; iconPos: EntryIconPosition; event: gdk.Event)!(self: ptr Entry00; iconPos: EntryIconPosition; event: ptr gdk.Event00)",
    ...
    "drag_action_requested!PlacesSidebar!3!(self: PlacesSidebar; context: gdk.DragContext; destFile: gio.GFile; sourceFileList: seq[gio.GFile]): int!(self: ptr PlacesSidebar00; context: ptr gdk.DragContext00; destFile: ptr gio.GFile00; sourceFileList: ptr glib.List): int32",
    "drag_perform_drop!PlacesSidebar!3!(self: PlacesSidebar; destFile: gio.GFile; sourceFileList: seq[gio.GFile]; action: int)!(self: ptr PlacesSidebar00; destFile: ptr gio.GFile00; sourceFileList: ptr glib.List; action: int32)",
    ...
    "begin!Gesture!1!(self: Gesture; sequence: gdk.EventSequence = nil)!(self: ptr Gesture00; sequence: ptr gdk.EventSequence00)",
    "cancel!Gesture!1!(self: Gesture; sequence: gdk.EventSequence = nil)!(self: ptr Gesture00; sequence: ptr gdk.EventSequence00)",
    "end!Gesture!1!(self: Gesture; sequence: gdk.EventSequence = nil)!(self: ptr Gesture00; sequence: ptr gdk.EventSequence00)",
    "sequence_state_changed!Gesture!2!(self: Gesture; sequence: gdk.EventSequence = nil; state: EventSequenceState)!(self: ptr Gesture00; sequence: ptr gdk.EventSequence00; state: EventSequenceState)",
    "update!Gesture!1!(self: Gesture; sequence: gdk.EventSequence = nil)!(self: ptr Gesture00; sequence: ptr gdk.EventSequence00)",
    ...
    "content_sniffed!Message!2!(self: Message; `type`: cstring; params: ptr HashTable00)!(self: ptr Message00; `type`: cstring; params: ptr HashTable00)",
    "got_chunk!Message!1!(self: Message; chunk: Buffer)!(self: ptr Message00; chunk: ptr Buffer00)",
    "network_event!Message!2!(self: Message; event: gio.SocketClientEvent; connection: gio.IOStream)!(self: ptr Message00; event: gio.SocketClientEvent; connection: ptr gio.IOStream00)",
    "wrote_body_data!Message!1!(self: Message; chunk: Buffer)!(self: ptr Message00; chunk: ptr Buffer00)",
    "event!Socket!2!(self: Socket; event: gio.SocketClientEvent; connection: gio.IOStream)!(self: ptr Socket00; event: gio.SocketClientEvent; connection: ptr gio.IOStream00)",
    "new_connection!Socket!1!(self: Socket; new: Socket)!(self: ptr Socket00; new: ptr Socket00)",
    "authenticate!Session!3!(self: Session; msg: Message; auth: Auth; retrying: bool)!(self: ptr Session00; msg: ptr Message00; auth: ptr Auth00; retrying: gboolean)",
    "connection_created!Session!1!(self: Session; connection: gobject.Object)!(self: ptr Session00; connection: ptr gobject.Object00)",
    "request_queued!Session!1!(self: Session; msg: Message)!(self: ptr Session00; msg: ptr Message00)",
    "request_started!Session!2!(self: Session; msg: Message; socket: Socket)!(self: ptr Session00; msg: ptr Message00; socket: ptr Socket00)",
    "request_unqueued!Session!1!(self: Session; msg: Message)!(self: ptr Session00; msg: ptr Message00)",
    "tunneling!Session!1!(self: Session; connection: gobject.Object)!(self: ptr Session00; connection: ptr gobject.Object00)",
    "authenticate!AuthManager!3!(self: AuthManager; msg: Message; auth: Auth; retrying: bool)!(self: ptr AuthManager00; msg: ptr Message00; auth: ptr Auth00; retrying: gboolean)",
    "changed!CookieJar!2!(self: CookieJar; oldCookie: Cookie; newCookie: Cookie)!(self: ptr CookieJar00; oldCookie: ptr Cookie00; newCookie: ptr Cookie00)",
    "changed!HSTSEnforcer!2!(self: HSTSEnforcer; oldPolicy: HSTSPolicy; newPolicy: HSTSPolicy)!(self: ptr HSTSEnforcer00; oldPolicy: ptr HSTSPolicy00; newPolicy: ptr HSTSPolicy00)",
    "hsts_enforced!HSTSEnforcer!1!(self: HSTSEnforcer; message: Message)!(self: ptr HSTSEnforcer00; message: ptr Message00)",
    "error!WebsocketConnection!1!(self: WebsocketConnection; error: ptr glib.Error)!(self: ptr WebsocketConnection00; error: ptr glib.Error)",
    "message!WebsocketConnection!2!(self: WebsocketConnection; `type`: int; message: glib.Bytes)!(self: ptr WebsocketConnection00; `type`: int32; message: ptr glib.Bytes00)",
    "pong!WebsocketConnection!1!(self: WebsocketConnection; message: glib.Bytes)!(self: ptr WebsocketConnection00; message: ptr glib.Bytes00)",
    "request_aborted!Server!2!(self: Server; message: Message; client: ClientContext)!(self: ptr Server00; message: ptr Message00; client: ptr ClientContext00)",
    "request_finished!Server!2!(self: Server; message: Message; client: ClientContext)!(self: ptr Server00; message: ptr Message00; client: ptr ClientContext00)",
    "request_read!Server!2!(self: Server; message: Message; client: ClientContext)!(self: ptr Server00; message: ptr Message00; client: ptr ClientContext00)",
    "request_started!Server!2!(self: Server; message: Message; client: ClientContext)!(self: ptr Server00; message: ptr Message00; client: ptr ClientContext00)",
    "authenticated!AuthenticationRequest!1!(self: AuthenticationRequest; credential: Credential)!(self: ptr AuthenticationRequest00; credential: ptr Credential00)",
    "update!PrintCustomWidget!2!(self: PrintCustomWidget; pageSetup: gtk.PageSetup; printSettings: gtk.PrintSettings)!(self: ptr PrintCustomWidget00; pageSetup: ptr gtk.PageSetup00; printSettings: ptr gtk.PrintSettings00)",
    "create_custom_widget!PrintOperation!0!(self: PrintOperation): PrintCustomWidget!(self: ptr PrintOperation00): PrintCustomWidget00",
    "failed!PrintOperation!1!(self: PrintOperation; error: ptr glib.Error)!(self: ptr PrintOperation00; error: ptr glib.Error)",
    "failed!WebResource!1!(self: WebResource; error: ptr glib.Error)!(self: ptr WebResource00; error: ptr glib.Error)",
    "failed_with_tls_errors!WebResource!2!(self: WebResource; certificate: gio.TlsCertificate; errors: gio.TlsCertificateFlags)!(self: ptr WebResource00; certificate: ptr gio.TlsCertificate00; errors: gio.TlsCertificateFlags)",
    "received_data!WebResource!1!(self: WebResource; dataLength: uint64)!(self: ptr WebResource00; dataLength: uint64)",
    "sent_request!WebResource!2!(self: WebResource; request: URIRequest; redirectedResponse: URIResponse)!(self: ptr WebResource00; request: ptr URIRequest00; redirectedResponse: ptr URIResponse00)",
    "authenticate!WebView!1!(self: WebView; request: AuthenticationRequest): bool!(self: ptr WebView00; request: ptr AuthenticationRequest00): gboolean",
    "context_menu!WebView!3!(self: WebView; contextMenu: ContextMenu; event: gdk.Event; hitTestResult: HitTestResult): bool!(self: ptr WebView00; contextMenu: ptr ContextMenu00; event: ptr gdk.Event00; hitTestResult: ptr HitTestResult00): gboolean",
    "create!WebView!1!(self: WebView; navigationAction: NavigationAction): gtk.Widget!(self: ptr WebView00; navigationAction: ptr NavigationAction00): gtk.Widget00",
    "decide_policy!WebView!2!(self: WebView; decision: PolicyDecision; decisionType: PolicyDecisionType): bool!(self: ptr WebView00; decision: ptr PolicyDecision00; decisionType: PolicyDecisionType): gboolean",
    "enter_fullscreen!WebView!0!(self: WebView): bool!(self: ptr WebView00): gboolean",
    "insecure_content_detected!WebView!1!(self: WebView; event: InsecureContentEvent)!(self: ptr WebView00; event: InsecureContentEvent)",
    "leave_fullscreen!WebView!0!(self: WebView): bool!(self: ptr WebView00): gboolean",
    "load_changed!WebView!1!(self: WebView; loadEvent: LoadEvent)!(self: ptr WebView00; loadEvent: LoadEvent)",
    "load_failed!WebView!3!(self: WebView; loadEvent: LoadEvent; failingUri: cstring; error: ptr glib.Error): bool!(self: ptr WebView00; loadEvent: LoadEvent; failingUri: cstring; error: ptr glib.Error): gboolean",
    "load_failed_with_tls_errors!WebView!3!(self: WebView; failingUri: cstring; certificate: gio.TlsCertificate; errors: gio.TlsCertificateFlags): bool!(self: ptr WebView00; failingUri: cstring; certificate: ptr gio.TlsCertificate00; errors: gio.TlsCertificateFlags): gboolean",
    "mouse_target_changed!WebView!2!(self: WebView; hitTestResult: HitTestResult; modifiers: int)!(self: ptr WebView00; hitTestResult: ptr HitTestResult00; modifiers: uint32)",
    "permission_request!WebView!1!(self: WebView; request: PermissionRequest | NotificationPermissionRequest | DeviceInfoPermissionRequest | WebsiteDataAccessPermissionRequest | UserMediaPermissionRequest | PointerLockPermissionRequest | MediaKeySystemPermissionRequest | InstallMissingMediaPluginsPermissionRequest | GeolocationPermissionRequest): bool!(self: ptr WebView00; request: ptr PermissionRequest00): gboolean",
    "print!WebView!1!(self: WebView; printOperation: PrintOperation): bool!(self: ptr WebView00; printOperation: ptr PrintOperation00): gboolean",
    "resource_load_started!WebView!2!(self: WebView; resource: WebResource; request: URIRequest)!(self: ptr WebView00; resource: ptr WebResource00; request: ptr URIRequest00)",
    "run_color_chooser!WebView!1!(self: WebView; request: ColorChooserRequest): bool!(self: ptr WebView00; request: ptr ColorChooserRequest00): gboolean",
    "run_file_chooser!WebView!1!(self: WebView; request: FileChooserRequest): bool!(self: ptr WebView00; request: ptr FileChooserRequest00): gboolean",
    "script_dialog!WebView!1!(self: WebView; dialog: ScriptDialog): bool!(self: ptr WebView00; dialog: ptr ScriptDialog00): gboolean",
    "show_notification!WebView!1!(self: WebView; notification: Notification): bool!(self: ptr WebView00; notification: ptr Notification00): gboolean",
    "show_option_menu!WebView!3!(self: WebView; menu: OptionMenu; event: gdk.Event; rectangle: gdk.Rectangle): bool!(self: ptr WebView00; menu: ptr OptionMenu00; event: ptr gdk.Event00; rectangle: gdk.Rectangle): gboolean",
    "submit_form!WebView!1!(self: WebView; request: FormSubmissionRequest)!(self: ptr WebView00; request: ptr FormSubmissionRequest00)",
    "user_message_received!WebView!1!(self: WebView; message: UserMessage): bool!(self: ptr WebView00; message: ptr UserMessage00): gboolean",
    "web_process_crashed!WebView!0!(self: WebView): bool!(self: ptr WebView00): gboolean",
    "web_process_terminated!WebView!1!(self: WebView; reason: WebProcessTerminationReason)!(self: ptr WebView00; reason: WebProcessTerminationReason)",
    "create_web_view!AutomationSession!0!(self: AutomationSession): WebView!(self: ptr AutomationSession00): WebView00",
    "created_destination!Download!1!(self: Download; destination: cstring)!(self: ptr Download00; destination: cstring)",
    "decide_destination!Download!1!(self: Download; suggestedFilename: cstring): bool!(self: ptr Download00; suggestedFilename: cstring): gboolean",
    "failed!Download!1!(self: Download; error: ptr glib.Error)!(self: ptr Download00; error: ptr glib.Error)",
    "received_data!Download!1!(self: Download; dataLength: uint64)!(self: ptr Download00; dataLength: uint64)",
    "automation_started!WebContext!1!(self: WebContext; session: AutomationSession)!(self: ptr WebContext00; session: ptr AutomationSession00)",
    "download_started!WebContext!1!(self: WebContext; download: Download)!(self: ptr WebContext00; download: ptr Download00)",
    "user_message_received!WebContext!1!(self: WebContext; message: UserMessage): bool!(self: ptr WebContext00; message: ptr UserMessage00): gboolean",
    "favicon_changed!FaviconDatabase!2!(self: FaviconDatabase; pageUri: cstring; faviconUri: cstring)!(self: ptr FaviconDatabase00; pageUri: cstring; faviconUri: cstring)",
    "start!GeolocationManager!0!(self: GeolocationManager): bool!(self: ptr GeolocationManager00): gboolean",
    "counted_matches!FindController!1!(self: FindController; matchCount: int)!(self: ptr FindController00; matchCount: uint32)",
    "found_text!FindController!1!(self: FindController; matchCount: int)!(self: ptr FindController00; matchCount: uint32)",
    "attach!WebInspector!0!(self: WebInspector): bool!(self: ptr WebInspector00): gboolean",
    "bring_to_front!WebInspector!0!(self: WebInspector): bool!(self: ptr WebInspector00): gboolean",
    "detach!WebInspector!0!(self: WebInspector): bool!(self: ptr WebInspector00): gboolean",
    "open_window!WebInspector!0!(self: WebInspector): bool!(self: ptr WebInspector00): gboolean",
    "changed!BackForwardList!2!(self: BackForwardList; itemAdded: BackForwardListItem = nil; itemsRemoved: pointer)!(self: ptr BackForwardList00; itemAdded: ptr BackForwardListItem00; itemsRemoved: pointer)",
    "script_message_received!UserContentManager!1!(self: UserContentManager; jsResult: JavascriptResult)!(self: ptr UserContentManager00; jsResult: ptr JavascriptResult00)",
    "committed!InputMethodContext!1!(self: InputMethodContext; text: cstring)!(self: ptr InputMethodContext00; text: cstring)",
    "delete_surrounding!InputMethodContext!2!(self: InputMethodContext; offset: int; nChars: int)!(self: ptr InputMethodContext00; offset: int32; nChars: uint32)",
    "console_message_sent!WebPage!1!(self: WebPage; consoleMessage: ConsoleMessage)!(self: ptr WebPage00; consoleMessage: ptr ConsoleMessage00)",
    "context_menu!WebPage!2!(self: WebPage; contextMenu: ContextMenu; hitTestResult: WebHitTestResult): bool!(self: ptr WebPage00; contextMenu: ptr ContextMenu00; hitTestResult: ptr WebHitTestResult00): gboolean",
    "form_controls_associated!WebPage!1!(self: WebPage; elements: PtrArray00Array)!(self: ptr WebPage00; elements: PtrArray00Array)",
    "form_controls_associated_for_frame!WebPage!2!(self: WebPage; elements: PtrArray00Array; frame: Frame)!(self: ptr WebPage00; elements: PtrArray00Array; frame: ptr Frame00)",
    "send_request!WebPage!2!(self: WebPage; request: URIRequest; redirectedResponse: URIResponse): bool!(self: ptr WebPage00; request: ptr URIRequest00; redirectedResponse: ptr URIResponse00): gboolean",
    "user_message_received!WebPage!1!(self: WebPage; message: UserMessage): bool!(self: ptr WebPage00; message: ptr UserMessage00): gboolean",
    "will_submit_form!WebPage!6!(self: WebPage; form: DOMElement; step: FormSubmissionStep; sourceFrame: Frame; targetFrame: Frame; textFieldNames: PtrArray00Array; textFieldValues: PtrArray00Array)!(self: ptr WebPage00; form: ptr DOMElement00; step: FormSubmissionStep; sourceFrame: ptr Frame00; targetFrame: ptr Frame00; textFieldNames: PtrArray00Array; textFieldValues: PtrArray00Array)",
    "window_object_cleared!ScriptWorld!2!(self: ScriptWorld; page: WebPage; frame: Frame)!(self: ptr ScriptWorld00; page: ptr WebPage00; frame: ptr Frame00)",
    "page_created!WebExtension!1!(self: WebExtension; webPage: WebPage)!(self: ptr WebExtension00; webPage: ptr WebPage00)",
    "user_message_received!WebExtension!1!(self: WebExtension; message: UserMessage)!(self: ptr WebExtension00; message: ptr UserMessage00)",
